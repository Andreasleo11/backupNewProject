...
@section('content')
  ...
  <button type="button" class="btn btn-primary" data-bs-toggle="modal"
    data-bs-target="#customerReportModal">
        ...
        <div class="modal-body">
          <form method="POST" action="{{ route('laporan-kerusakan.store') }}">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="penanggulangan" name="penanggulangan"
                required>
            </div>
            <div class="mb-3">
  ...
  <div class="modal fade" id="customerReportModal" tabindex="-1"
    aria-labelledby="customerReportModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
    ...
    <tbody>
      @foreach ($summaries as $index => $summary)
        <tr>
          ...
          <td>
            <a href="{{ route('laporan-kerusakan.show', $summary->id) }}"
