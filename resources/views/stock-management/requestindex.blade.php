...
@section('content')
    ...
    <form method="GET" action="{{ route('testing.request') }}" class="mb-3">
        <div class="row g-3 align-items-end">
            ...
            <div class="col-md-4">
                ...
                <input type="month" class="form-control" id="filterMonth" name="month" value="{{ request('month') }}">
            </div>
            <div class="col-md-4">
    ...
    <div class="modal fade" id="addStockRequestModal" tabindex="-1" aria-labelledby="addStockRequestModalLabel"
        aria-hidden="true">
                ...
                <form method="POST" action="{{ route('stockrequest.store') }}">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="stockRequest" name="stockRequest" required>
                        </div>
                        <div class="mb-3">
    ...
    <div class="mt-3">
        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addStockRequestModal">
            Add Stock Request
        </button>
    </div>
