...
<div class="button-container">
    ...
    <a href="{{ route('updated.barcode.item.position') }}" class="btn btn-primary">Latest Barcode Item</a> <br>
    <br>
    ...
    <a href="{{ route('missingbarcode.index')}}" class="btn btn-secondary">Missing Barcode Generator</a>
</div>
