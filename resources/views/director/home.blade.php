...
@section('content')
  ...
  <div class="text-end">
    <div class="dropdown">
      <button class="btn btn-primary dropdown-toggle px-4 py-2 fw-bold" type="button"
        id="viewSelectorBtn" data-bs-toggle="dropdown" aria-expanded="false">
        Select View
      </button>
  ...
  <div id="view-2" class="d-none">
    ...
    <!-- Modal -->
    <div class="modal fade" id="filteredEmployeesModal" tabindex="-1"
      aria-labelledby="filteredEmployeesModalLabel" aria-hidden="true">
