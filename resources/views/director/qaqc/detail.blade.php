    ...
    <div class="row text-center">
      <div class="col">
        ...
        @if (Auth::check() &&
                ...
                $currentUser->specification->name == 'INSPECTOR')
          <button class="btn btn-primary" onclick="addAutograph(1, {{ $report->id }})">Acc QC
            Inspector</button>
        @endif
      ...
      <div class="col">
        ...
        @if (Auth::check() &&
                $currentUser->department->name == 'QC' &&
                $currentUser->specification->name == 'LEADER')
          <button class="btn btn-primary" onclick="addAutograph(2, {{ $report->id }})">Acc QC
            Leader</button>
        @endif
      ...
      <div class="col">
        ...
        @if (Auth::check() &&
          ...
          <button class="btn btn-primary"
            onclick="addAutograph(3, {{ $report->id }}, {{ $user->id }})">Acc
            QC Head</button>
        @endif
