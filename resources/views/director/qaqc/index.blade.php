        ...
        <div class="card-body p-0">
            <div class="table-responsive p-4">
                <div class="mb-3">
                    ...
                    <button id="reject-selected-btn" data-reject-url="{{ route('director.qaqc.rejectSelected') }}" class="btn btn-danger">Reject Selected</button>
    ...
    <script>
        ...
        function getSelectedReportIdsWithStatus() {
            ...
            checkboxes.forEach(function(checkbox) {
                ...
                reportIdWithStatus.push({ id: reportId, approvalStatus: approvalStatus, docNum: docNum});
            });
        ...
        var approvalStatus = {/* Map of report IDs to their approval status (e.g., 'approved', 'rejected') */};
