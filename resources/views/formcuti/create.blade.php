...
@section('content')
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6" x-data="{ agreed: false }">
        ...
        <div class="rounded-2xl border border-slate-200 bg-white shadow-sm">
            <form method="POST" action="{{ route('formcuti.insert') }}" class="p-4 sm:p-6 space-y-5">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input
                            class="mt-1 block w-full rounded-lg border border-slate-300 bg-white px-3 py-2.5 text-sm text-slate-900 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/60"
                            type="text" id="no_karyawan" name="no_karyawan" value="{{ old('no_karyawan') }}" required>
                        @error('no_karyawan')
                            <p class="mt-1 text-[11px] text-red-500">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input
                            class="mt-1 block w-full rounded-lg border border-slate-300 bg-white px-3 py-2.5 text-sm text-slate-900 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/60"
                            type="text" id="jabatan" name="jabatan" value="{{ old('jabatan') }}">
                        @error('jabatan')
                            <p class="mt-1 text-[11px] text-red-500">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <select
                            ...
                            <option value="tahun" {{ old('jenis_cuti') == 'tahun' ? 'selected' : '' }}>Cuti Tahunan
                            </option>
                        </select>
                        @error('jenis_cuti')
                            <p class="mt-1 text-[11px] text-red-500">{{ $message }}</p>
                    ...
                    <div>
                        ...
                        <div class="mt-1 flex gap-2">
                            <input
                                ...
                                type="text" id="waktu_cuti" name="waktu_cuti" value="{{ old('waktu_cuti') }}" required>
                            <select
                                ...
                                id="satuan_waktu_cuti" name="satuan_waktu_cuti" required>
                                <option value="jam" {{ old('satuan_waktu_cuti') == 'jam' ? 'selected' : '' }}>Jam
                                </option>
                                <option value="hari" {{ old('satuan_waktu_cuti') == 'hari' ? 'selected' : '' }}>Hari
                                </option>
                            </select>
                        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input
                            class="mt-1 block w-full rounded-lg border border-slate-300 bg-white px-3 py-2.5 text-sm text-slate-900 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/60"
                            type="text" id="pengganti" name="pengganti" value="{{ old('pengganti') }}">
                        @error('pengganti')
                            <p class="mt-1 text-[11px] text-red-500">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="space-y-3">
                        ...
                        <div>
                            ...
                            <input
                                class="mt-1 block w-full rounded-lg border border-slate-300 bg-white px-3 py-2.5 text-sm text-slate-900 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/60"
                                type="date" id="tanggal_permohonan" name="tanggal_permohonan"
                    ...
                    <div class="space-y-3">
                        <div>
                            ...
                            <input
                                class="mt-1 block w-full rounded-lg border border-slate-300 bg-white px-3 py-2.5 text-sm text-slate-900 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/60"
                                type="date" id="mulai_tanggal" name="mulai_tanggal"
                                value="{{ old('mulai_tanggal') }}" required>
                        </div>
                        ...
                        <div>
                            ...
                            <input
                                class="mt-1 block w-full rounded-lg border border-slate-300 bg-white px-3 py-2.5 text-sm text-slate-900 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/60"
                                type="date" id="sampai_tanggal" name="sampai_tanggal"
                ...
                <div class="mt-4 border-t border-slate-100 pt-4">
                    <label class="inline-flex items-start gap-2 text-xs text-slate-600 cursor-pointer">
                        <input class="mt-0.5 h-4 w-4 rounded border-slate-300 text-indigo-600 focus:ring-indigo-500"
                            type="checkbox" id="keterangan_user" name="keterangan_user" value="1" required
                            x-model="agreed">
                        <span>
                            Saya yang membuat form cuti ini dengan sebenar-benarnya dan bertanggung jawab atas data yang
                            saya isi.
                        </span>
                    </label>
                </div>
