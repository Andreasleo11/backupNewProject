                    ...
                    <form method="POST" action="{{ route('formcuti.insert') }}" class="row g-3">
                        ...
                        <div class="form-group mt-3 col-md-6">
                            <div class="row g-2">
                                ...
                                <div class="col">
                                    <input class="form-control" type="text" id="waktu_cuti" name="waktu_cuti" required>
                                </div>
                                <div class="col-auto">
                                    <select class="form-select" id="satuan_waktu_cuti" name="satuan_waktu_cuti" required>
                        ...
                        <div class="form-group mt-3 col-md-6">
                            ...
                            <input class="form-control" type="date" id="mulai_tanggal" name="mulai_tanggal" required>
                        </div>

                        <div class="form-group mt-3 col-md-6">
                            <label class="form-label" for="sampai_tanggal">Sampai Tanggal</label>
                            <input class="form-control" type="date" id="sampai_tanggal" name="sampai_tanggal" required>
                        </div>

                        <div class="form-group mt-4">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="keterangan_user" name="keterangan_user" value="1" required class="form-group mt-3">
