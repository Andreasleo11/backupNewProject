...
@section('content')
            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-3 mb-4">
                <div>
                    <h1 class="text-xl md:text-2xl font-semibold text-slate-900">
                        ...
                        <span class="text-indigo-600">(Distribution Section)</span>
                    </h1>
                    <p class="mt-1 text-sm text-slate-500">
                        Distribusi kapasitas berdasarkan forecast per periode / kategori.
                    </p>
                </div>
                ...
                <div class="overflow-x-auto rounded-xl border border-slate-200 bg-white shadow-sm">
                    <div class="p-3">
                        <div class="overflow-x-auto">
                            {{-- Kalau mau override class tabel DataTables bisa pakai array options --}}
    ...
    {{-- Script Yajra DataTables tetap dipanggil --}}
    {{ $dataTable->scripts() }}
@endsection
