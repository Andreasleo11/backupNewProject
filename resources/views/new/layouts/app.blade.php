...
<body
    ...
    x-data="{ sidebarOpen: false, sidebarCollapsed: false, q: '' }"
    x-cloak
>
    {{-- Mobile sidebar --}}
    ...
    <div class="min-h-screen flex">
        {{-- Desktop sidebar --}}
        <aside
            class="hidden md:flex flex-col border-r border-slate-200 bg-white transition-all duration-200"
            ...
            <div class="flex items-center justify-between h-14 px-3 border-b border-slate-200">
                ...
                <a href="{{ url('/') }}" class="flex items-center gap-2">
                    ...
                    <span
                        ...
                        x-cloak
                        class="relative inline-block text-sm font-semibold text-slate-900"
        ...
        <div class="flex-1 flex flex-col min-w-0">
            ...
            <header class="flex h-14 items-center justify-between border-b border-slate-200 bg-white px-4 md:px-6">
                <div class="flex items-center gap-3">
                    {{-- Mobile menu button --}}
                    <button type="button"
                            class="md:hidden rounded-md border border-slate-200 p-1.5 text-slate-500"
                ...
                <div class="flex items-center gap-3">
                    <div class="hidden sm:flex flex-col text-right text-xs leading-tight">
            ...
            <main class="flex-1 overflow-y-auto px-4 py-4 md:px-6 md:py-6">
                @if (session('success'))
                    <div class="mb-3 rounded-lg border border-emerald-200 bg-emerald-50 px-4 py-3 text-xs text-emerald-800">
                        {{ session('success') }}
                    </div>
                @endif
