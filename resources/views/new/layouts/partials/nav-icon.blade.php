@switch($name)
    ...
    @case('building')
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-5 w-5">
            <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 21V6.75L12 3l3.75 3.75V21m-9 0h10.5m-10.5 0V10.5a2.25 2.25 0 0 1 2.25-2.25h4.5a2.25 2.25 0 0 1 2.25 2.25V21m-9 0h9" />
        </svg>
    @break

    @case('wrench')
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-5 w-5">
            <path stroke-linecap="round" stroke-linejoin="round" d="M11.423 20.365a6.001 6.001 0 0 1-7.038-7.038l6.305-6.305a4.5 4.5 0 1 1 6.364 6.364l-6.305 6.305c-.144.144-.306.27-.482.378" />
