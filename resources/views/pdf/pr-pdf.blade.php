...
<style>
    ...
    .signature-title {
        ...
        font-size: 10px;
        color: #555;
        margin-bottom: 50px; /* Space for the signature image / signature line */
    ...
    .signature-img {
        ...
        max-width: 120px;
        margin-bottom: 5px;
        margin-top: -45px; /* Pull it up into the empty 50px space */
    }
    ...
    <div class="info-section">
        <table class="info-table">
            ...
            <tr>
                ...
                <td colspan="3" style="padding-top: 10px; font-style: italic;">"{{ $purchaseRequest->remark }}"</td>
            </tr>
            @endif
        </table>
    </div>
