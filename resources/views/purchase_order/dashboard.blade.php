...
@section('content')
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="topVendorsModalLabel">Top 5 Vendors with the Highest Total
            </h5>
      ...
      <div class="col-md-12">
        <div class="card">
          <div class="ps-3 pt-3">
            ...
            <div class="text-secondary">List of vendor with sum total based on the selected month.
            </div>
          </div>
          <div class="card-body">
  ...
  <div class="modal fade" id="vendorMonthlyTotalsModal" tabindex="-1"
    aria-labelledby="vendorMonthlyTotalsModalLabel" aria-hidden="true">
  ...
  <div class="modal fade" id="vendorPOModal" tabindex="-1" aria-labelledby="vendorPOModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
...
@push('extraJs')
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      ...
      const monthlyTotalsChartCtx = document.getElementById('monthlyTotalsChart').getContext(
        '2d');
