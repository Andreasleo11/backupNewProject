...
@section('content')
    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div class="bg-white shadow-sm ring-1 ring-slate-200 rounded-xl">
            <form action="{{ route('po.store') }}" method="POST" enctype="multipart/form-data" class="p-5 space-y-5">
                @csrf
                ...
                @if (!empty($parentPONumber))
                    <div>
                        ...
                        <input id="parent_po_number" name="parent_po_number" type="text" readonly
                ...
                <div>
                    ...
                    <input id="po_number" name="po_number" type="number" required placeholder="2556622"
                        value="{{ old('po_number') }}"
                ...
                <div>
                    ...
                    <input id="vendor_name" name="vendor_name" type="text" required placeholder="PT. MAJU TERUS"
                ...
                <div>
                    ...
                    <input id="invoice_date" name="invoice_date" type="text" required placeholder="18.11.24"
                        value="{{ old('invoice_date') }}" aria-describedby="poDateHelp"
                        class="block w-full rounded-lg border border-slate-300 px-3 py-2 text-sm text-slate-900 focus:border-indigo-500 focus:ring-indigo-500">
                ...
                <div>
                    ...
                    <input id="invoice_number" name="invoice_number" type="text" required placeholder="98/MT/223/03"
                ...
                <div>
                    ...
                    <div class="flex gap-2">
                        ...
                        <div class="flex-1">
                            <input id="total" name="total" type="text" required placeholder="1,498,000"
                                value="{{ old('total') }}"
                                class="block w-full rounded-lg border border-slate-300 px-3 py-2 text-sm text-slate-900 focus:border-indigo-500 focus:ring-indigo-500">
                        </div>
                    </div>
