                    ...
                    <div class="row">
                        <div class="col">
                            <div class="card border-0 shadow-sm rounded">
                                <div class="card-body">
                                    <form action="{{ route('hrd.importantDocs.store') }}" method="POST"
                                        enctype="multipart/form-data" class="needs-validation px-3" novalidate>
                                        ...
                                        <div class="form-group mt-4">
                                            ...
                                            <select id="typeSelect"
                                                class="form-select @error('type_id') is-invalid @enderror" name="type_id"
                                                aria-label="Default select example" value="{{ old('type') }}" required>
                                        ...
                                        <div class="form-group mt-4">
                                            ...
                                            <div class="form-text text-secondary">e.g KITAS Raymond Lay, BPKB Mobil Alphard
                                                F 1223 ED</div>
                                        ...
                                        <div class="form-group mt-4">
                                            <label class="fw-medium fs-5 mb-2">Document ID <span
                                                    class="text-secondary h6">(Optional)</label>
                                            <input type="text"
                                                class="form-control @error('document_id') is-invalid @enderror"
                                                name="document_id" value="{{ old('document_id') }}">
                                        ...
                                        <div class="form-group mt-4">
                                            <label class="fw-medium fs-5 mb-2">Description <span
                                                    class="text-secondary h6">(Optional)</span></label>
                                            <textarea name="description" rows="3" class="form-control @error('description') is-invalid @enderror"
                                                value="{{ old('description') }}"></textarea>

                                            <div class="valid-feedback">Looks good!</div>
                                            <div class="invalid-feedback">You must fill the description of the document
                                            </div>
                                        ...
                                        <div class="form-group mt-4">
                                            <label class="fw-medium fs-5 mb-2">Upload file <span
                                                    class="text-secondary h6">(Optional)</span>{{ csrf_field() }}</label>
                                            <input type="file" id="fileInput" class= "form-control" name="files[]"
                                                value="{{ old('files') }}">
