...
<div class="space-y-4">
        ...
        @else
            <div class="p-4 grid grid-cols-1 sm:grid-cols-2 gap-3">
                @foreach ($importantDoc->files as $file)
                    ...
                    <div class="flex items-center justify-between p-3 rounded-xl border border-slate-100 bg-slate-50/50 group hover:border-indigo-200 transition-all">
    ...
    <div class="flex items-center justify-between pt-2">
        <span class="text-[10px] font-bold text-slate-400 uppercase tracking-widest truncate">Updated: {{ $importantDoc->updated_at->diffForHumans() }}</span>
