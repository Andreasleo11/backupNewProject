          ...
          <form action="{{ route('purchaserequest.insert') }}" method="POST" class="row ">
            ...
            <div class="form-group mt-5 col-md-2">
              ...
              <div class="form-check">
                <input class="form-check-input" type="radio" name="is_draft" id="yesRadio"
                  value="1" {{ old('is_draft') == '1' ? 'checked' : '' }}>
                <label class="form-check-label" for="yesRadio">
                  Yes
                </label>
              </div>
              <div class="form-check">
                <input class="form-check-input" type="radio" name="is_draft" id="noRadio"
                  value="0" checked>
            ...
            <div class="form-group mt-5 col">
              ...
              <div class="form-text">Ubah hanya jika ingin membuat PR diluar dari departemen sendiri
              </div>
            </div>
            ...
            <div class="form-group mt-5 col">
              ...
              <select class="form-select" name="to_department" id="toDepartmentDropdown" required>
                ...
                <option value="Maintenance"
                  {{ old('to_department') == 'Maintenance' ? 'selected' : '' }}>
                  Maintenance</option>
                <option value="Purchasing"
                  {{ old('to_department') == 'Purchasing' ? 'selected' : '' }}>
                  Purchasing</option>
