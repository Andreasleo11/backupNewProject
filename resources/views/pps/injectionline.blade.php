                ...
                <div
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-xs text-slate-500">
                            Pilih line mesin yang akan digunakan dalam perhitungan PPS Injection.
                        </p>
                    </div>

                    <a href="{{ route('finalinjectionpps') }}"
                ...
                <div class="px-6 py-4">
                    <div class="rounded-xl border border-slate-200 bg-slate-50/40">
                        <div class="overflow-x-auto">
                            {{-- Tetap pakai Yajra DataTable, hanya wrapper-nya yang pakai Tailwind --}}
                        ...
                        <div class="px-4 py-2 border-t border-slate-100 text-[11px] text-slate-400">
                            Tips: gunakan search & sorting untuk memastikan line yang dipilih sudah benar.
                        </div>
                    </div>
                </div>
            </div>
