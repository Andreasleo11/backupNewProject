...
@section('content')
  <form action="{{ route('processKarawangForm') }}" method="POST">
    ...
    <div class="form-group">
      ...
      <input type="number" name="hm_fg" id="hm_fg" value="{{ $data[0]->val_int_kri }}"
        class="form-control" required>
    </div>
    <div class="form-group">
      <label for="hm_wip">Jarak H-Min WIP (hari):</label>
      <input type="number" name="hm_wip" id="hm_wip" value="{{ $data[1]->val_int_kri }}"
        class="form-control" required>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="number" name="max_mould_change" id="max_mould_change"
        value="{{ $data[4]->val_int_kri }}" class="form-control" required>
    </div>
    <div class="form-group">
