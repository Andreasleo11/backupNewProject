    ...
    <div class="container py-5">
        ...
        <form method="GET" class="row g-3 align-items-end mb-4">
            <div class="col-md-4">
                ...
                <input type="date" name="filter_start_date" id="filter_start_date" value="{{ $filter_start_date }}"
                    class="form-control shadow-sm">
            </div>
            <div class="col-md-4">
                <label for="filter_end_date" class="form-label">Tanggal Selesai</label>
                <input type="date" name="filter_end_date" id="filter_end_date" value="{{ $filter_end_date }}"
                    class="form-control shadow-sm">
            </div>
            <div class="col-md-auto">
                ...
                <a href="{{ route('reports.depthead.show', $employee_id) }}" class="btn btn-outline-secondary px-4">
        ...
        @if ($reports->isEmpty())
            <div class="alert alert-warning text-center">
                <i class="bi bi-exclamation-triangle-fill me-2"></i> Tidak ada laporan tersedia untuk karyawan ini.
            </div>
        @else
            <!-- Styles -->
