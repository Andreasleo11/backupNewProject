  ...
  <div class="row align-items-center">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-danger" form="reject-form">Confirm
                  Reject</button>
              </div>
            </div>
          </div>
    ...
    @if ($user->name === 'Bernadett')
      <div class="col-auto">
        ...
        <button type="button" class="btn btn-danger" data-bs-toggle="modal"
          data-bs-target="#rejectHrdModal">
          Reject
        </button>

        <!-- Reject Modal -->
        <div class="modal fade" id="rejectHrdModal" tabindex="-1"
          aria-labelledby="rejectHrdModalLabel" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
              ...
              <div class="modal-body">
                <form method="POST" action="{{ route('reject.hrd.yayasan') }}"
                  id="reject-hrd-form">
                  @csrf
                  <input type="hidden" name="filter_month" id="rejectbulanDepthead">
                  <input type="hidden" name="filter_year" id="rejecttahunDepthead">
              ...
              <div class="modal-footer">
                <button type="button" class="btn btn-secondary"
                  data-bs-dismiss="modal">Cancel</button>
                <button type="submit" class="btn btn-danger" form="reject-hrd-form">Confirm
                  Reject</button>
              </div>
            </div>
          </div>
      ...
      <div class="modal fade" id="uploadModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="{{ route('file.upload.evaluation') }}" method="POST"
                ...
                <input type="hidden" name="department"
                  value="{{ Auth::user()->department->dept_no }}">
    ...
    <script type="module">
      $(function() {
        ...
        function applyFilter(realMonth, realYear) {
          ...
          dataTable.column(6).search(formattedYear + '-' + formattedMonth + '-', true, false)
            .draw();
      ...
      document.getElementById('year-filter').addEventListener('change', function() {
        var filterMonth = document.getElementById('status-filter')
          .value; // Get month from the dropdown
      ...
      $(document).ready(function() {
        ...
        $(document).on('click', '.buttons-print', function() {
          ...
          $(".dt-buttons .buttons-print").attr("title", "Report for " + formattedMonth + "/" +
            formattedYear);
        });
      });
    </script>
