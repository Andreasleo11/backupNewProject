            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="material_consump" name="material_consump" required>
                    </div>

                    <div class="form-group">
                        <label for="dimension_tooling">Dimension Tooling:</label>
                        <input type="text" class="form-control" id="dimension_tooling" name="dimension_tooling">
                    </div>
                    ...
                    <div class="col-md-">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="request_trial" name="request_trial" required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="time_set_up_tooling" name="time_set_up_tooling" >
                            </div>

                            <div class="form-group">
                                <label for="time_setting_tooling">Time Setting Tooling:</label>
                                <input type="text" class="form-control" id="time_setting_tooling" name="time_setting_tooling">
                            </div>

                            <div class="form-group">
                                <label for="time_finish_inject">Time Finish Inject:</label>
                                <input type="text" class="form-control" id="time_finish_inject" name="time_finish_inject">
                            </div>

                            <div class="form-group">
                                <label for="time_set_down_tooling">Time Set Down Tooling:</label>
                                <input type="text" class="form-control" id="time_set_down_tooling" name="time_set_down_tooling">
                            </div>
