                    ...
                    <tbody>
                        ...
                        @foreach ($materials as $material)
                                ...
                                @if ($previousMaterialCode !== null)
                                    <tr>
                                        ...
                                        @foreach ($monthlyfgs as $monthlyfg)
                                            <td align="center" style="vertical-align: middle;">
                                                <strong>{{ $monthlyfg }}</strong></td>
                                        @endforeach
                                        <td></td>
                                        <td align="center" style="vertical-align: middle;">
                                            <strong>{{ array_sum($monthlyfgs) }}</strong></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        @foreach ($monthlyTotalPredictions as $monthlyTotalPrediction)
                                            <td align="center" style="vertical-align: middle;">
                                                <strong>{{ $monthlyTotalPrediction }}</strong></td>
                                        @endforeach
                                        <td></td>
                                        <td align="center" style="vertical-align: middle;">
                                            <strong>{{ array_sum($monthlyTotalPredictions) }}</strong></td>
                                    </tr>
                            ...
                            <tr>
                                ...
                                <td rowspan=2 align="center" style="vertical-align: middle;">{{ $material->item_no }}
                                </td>
                                <td rowspan=2 align="center" style="vertical-align: middle;">
                        ...
                        <tr>
                            ...
                            @foreach ($monthlyfgs as $monthlyfg)
                                <td align="center" style="vertical-align: middle;"><strong>{{ $monthlyfg }}</strong>
                                </td>
                            @endforeach
                            <td></td>
                            <td align="center" style="vertical-align: middle;">
