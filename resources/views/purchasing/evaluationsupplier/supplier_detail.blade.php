            ...
            <table style="width: 100%; border-collapse: collapse; text-align: left;">
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="border: 1px solid #ddd; padding: 8px;">Diteruskan, tidak perlu dilakukan Audit
                            Supplier, cukup Evaluasi Supplier 1 tahun sekali</td>
                    </tr>
                    <tr>
                        <td style="border: 1px solid #ddd; padding: 8px;"><strong>Grade B</strong></td>
                        <td style="border: 1px solid #ddd; padding: 8px;">Dipertahankan dan dilakukan Audit Supplier
                            setelah 1-3 bulan dari Evaluasi Supplier tahunan</td>
                    </tr>
                    <tr>
                        <td style="border: 1px solid #ddd; padding: 8px;"><strong>Grade C</strong></td>
                        <td style="border: 1px solid #ddd; padding: 8px;">Dilakukan Monitoring performa selama 3 bulan
                            dan dilakukan Audit Supplier di bulan berikutnya. Gradenya harus naik, bila gradenya tidak
