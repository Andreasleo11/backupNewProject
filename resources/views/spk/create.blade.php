...
@section('content')
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col">
        <form action="{{ route('spk.input') }}" method="post" enctype="multipart/form-data"
          id="spkForm">
          @csrf
          <div class="card mt-2">
            <div class="card-body">
              ...
              <div class="form-group row mt-3">
                ...
                <div class="col-sm-10">
                  <input type="text" name="pelapor" id="pelapor" value="{{ $username }}"
            ...
            <div class="card-body">
              ...
              <div class="row mt-3">
                <div class="col">
                  <div class="form-group">
                    ...
                    <select class="form-select" name="from_department" id="departmentDropdown"
                      required>
                ...
                <div class="col">
                  <div class="form-group">
                    <label for="toDepartmentDropdown" class="fw-semibold col-form-label">To
                      Department <span class="text-danger">*</span></label>
                    <select class="form-select" name="to_department" id="toDepartmentDropdown"
                      required>
              ...
              <div class="form-group mt-3">
                <label for="judul_laporan" class="fw-semibold form-label">Judul Laporan <span
                    class="text-danger">*</span></label>
                <input type="text" name="judul_laporan" id="judul_laporan" value=""
              ...
              <div class="form-group mt-3">
                <label for="keterangan_laporan" class="fw-semibold form-label">Keterangan Laporan
                  <span class="text-danger">*</span></label>
                <textarea name="keterangan_laporan" id="keterangan_laporan" cols="30" rows="10"
                  class="form-control"
