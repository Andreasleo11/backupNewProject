...
@section('content')
          ...
          <div class="col-md-8">
            <div class="card mt-2">
              <div class="card-body">
                ...
                <form id="formFinishSPK" action="{{ route('spk.finish', $report->id) }}"
                    ...
                    <div class="form-group mt-3 row">
                      ...
                      <div class="col-sm-9 mt-2">
                        ...
                        <div class="form-check form-check-inline">
                          ...
                          <label class="form-check-label" for="inlineRadioMachine">Machine</label>
                        </div>
                      </div>
                    </div>
                  @endif
                    ...
                    <div class="col-sm-9">
                      @php
                        ...
                        if ($tanggalMulai->isSameDay($tanggalSelesai)) {
                            ...
                            $lamaPengerjaan =
                                $totalDays . ' Hari ' . $remainingTime->format('%H Jam %I Menit');
                        }
                      @endphp
  ...
  @include('partials.uploaded-section', [
      'files' => $files,
      'showDeleteButton' =>
          $report->pelapor === $authUser->name || $report->status_laporan === 2,
  ])
