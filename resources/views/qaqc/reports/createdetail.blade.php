...
<div class="table-responsive">
    ...
    function addDataRow(detail = {}) {
        ...
        <input required type="number" value="${rowCount}" name="rowCount" class="d-none"></input>
            <td>${rowCount}</td>
            <td><input required type="text" id="itemNameInput${rowCount}" value="${detail.Part_Name ?? ''}" name="itemName${rowCount}" placeholder="Enter item name" autocomplete="off">
                        <div id="itemDropdown${rowCount}" class="dropdown-content"></div></td>

            <td><input required type="number" value="${detail.Rec_Quantity ?? ''}" name="rec_quantity${rowCount}" class="rec-input"></td>
            <td><input required type="number" value="${detail.Verify_Quantity ?? ''}" name="verify_quantity${rowCount}" class="verify-input"></td>
            <td><input required type="date" value="${detail.Prod_Date ?? ''}" name="prod_date${rowCount}" class="prod-input"></td>
            <td><input required type="number" value="${detail.Shift ?? ''}" name="shift${rowCount}" class="shift-input"></td>
            <td><input required type="number" value="${detail.Can_Use ?? ''}" name="can_use${rowCount}" class="canuse-input"></td>
            <td><input required type="number" value="${detail.Cant_Use ?? ''}" name="cant_use${rowCount}" class="cantuse-input"></td>
