    ...
    <div class="row">
      ...
      <div class="col-auto">
        ...
        @if ($user->specification->name !== '-')
          <button class="btn btn-outline-primary" data-bs-target="#upload-files-modal"
            data-bs-toggle="modal">
      ...
      @if ($adjustForm)
        <div class="col-auto">
          <form action="{{ route('adjustview') }}" method="get"
            ...
            <button type="submit" class="btn btn-outline-success" id="finishBtn">View Adjust Form
            </button>
          </form>
        </div>
      @endif
      ...
      <div class="col">
        ...
        @if (Auth::check() &&
          ...
          <button id="btn2" class="btn btn-primary"
            onclick="addAutograph(2, {{ $report->id }})">Acc QC
            Leader</button>
        @endif
      </div>
      ...
      <div class="col">
        ...
        @if (Auth::check() &&
          ...
          <button id="btn3" class="btn btn-primary"
            onclick="addAutograph(3, {{ $report->id }}, {{ $user->id }})">Acc QC/QA
            Head</button>
        @endif
      </div>
    </div>
                ...
                <tr>
                  ...
                  <td>
                    <button data-bs-target="#edit-do-number-{{ $detail->id }}"
                      data-bs-toggle="modal"
                      class="btn btn-primary btn-sm @if ($report->is_approve === 1) d-none @endif">Edit
                      DO Number</button>
                  </td>
                </tr>
              @empty
