                            ...
                            <div class="col-flex-grow-1 border-bottom p-0">
                                ...
                                <div class="border-top pt-4 px-4">
                                    <div class="mb-4">
                                        ...
                                        <p class="text-secondary mt-2">You need to add part defects for each of part details that you have
                            ...
                            <div class="col-9 p-4">
                                @foreach ($details as $index => $detail)
                                    <div class="tab-content" id="nav-tabContent">
                                        <div class="tab-pane fade show @if(session('active_tab') == $detail->id) active @endif" id="list-detail{{ $detail->id }}" role="tabpanel">
                                            <div class="mb-3 row">
                                                <div class="col">
                                                    ...
                                                    <tbody>
                                                        @forelse($detail->defects as $defect)
                                                            <tr class="text-center align-middle">
                                                                ...
                                                                <td>
                                                                    <form action="{{ route('qaqc.report.deletedefect', $defect->id) }}" method="post">
                                                                        @csrf
                                                                        @method('DELETE')
