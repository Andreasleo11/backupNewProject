                    ...
                    <form method="POST" action="{{ route('formkeluar.insert') }}" class="row gx-3 p-3">
                        ...
                        <div class="form-group mt-3 col-md-4">
                            <div class="row g-2">
                                ...
                                <div class="col">
                                    <input class="form-control" type="text" id="waktu_keluar" name="waktu_keluar" required>
                                </div>
                                <div class="col-auto">
                                    <select class="form-select" id="satuan_waktu_keluar" name="satuan_waktu_keluar" required>
                        ...
                        <div class="form-group mt-4">
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" id="keterangan_user" name="keterangan_user" value="1" required>
                                <label for="keterangan_user" class="form-check-label">Saya yang membuat form keluar ini dengan sebenar benarnya</label>
                            </div>
                        </div>
