<div class="modal fade modal-lg" tabindex="-1" id="addVerificationReportDetailModal" aria-labelledby="addVerificationReportDetailModal" aria-hidden="true">
                        ...
                        <div class="row">
                            ...
                            <div class="col-2">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="other" class="form-control mt-2" id="otherInput" style="display: none">
                                </div>
                            </div>
