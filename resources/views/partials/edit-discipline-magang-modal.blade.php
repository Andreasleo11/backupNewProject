<div class="modal" tabindex="-1" class="modal fade"
    id="edit-discipline-magang-modal-{{ str_replace(' ', '', $employee->id) }}" aria-labelledby="editModalLabel"
    aria-hidden="true">
        ...
        <div class="modal-content">
            <form method="POST" action="{{ route('updatemagang', $employee->id) }}">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">Discipline Point For {{ $employee->karyawan->name }}
                        {{ $employee->id }}</h5>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" maxlength="1" name="lembur" class="form-control" id="lembur"
                                    pattern="[A-E]" value="{{ $employee->lembur }}">
                            </div>
                        </div>
                    </div>
                    <div class="form-group mt-4">
