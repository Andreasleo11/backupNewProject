            ...
            <div class="flex min-h-full items-center justify-center p-4">
                <div class="relative w-full max-w-lg transform overflow-hidden rounded-2xl bg-white shadow-2xl transition-all"
                    ...
                    <form method="POST" action="{{ route($route, $id) }}" class="p-6">
                        ...
                        <div class="mb-6">
                            <div class="mb-4 flex items-start gap-3 rounded-lg bg-orange-50 p-4 border border-orange-100">
                                <i class='bx bx-info-circle text-xl text-orange-600'></i>
                                <div class="text-sm text-orange-800">
                                    <p class="font-medium">The creator will be notified to revise this {{ strtolower($entityName) }}.</p>
                            ...
                            <p class="mt-1 text-xs text-slate-500 font-medium">Minimum 10 characters required for submission.</p>
                        </div>
