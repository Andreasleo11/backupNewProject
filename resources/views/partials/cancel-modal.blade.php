@php
    ...
    $triggerClass = $triggerClass ?? 'w-full flex items-center justify-center gap-2 rounded-xl border border-rose-200 bg-rose-50/50 py-3 text-sm font-bold text-rose-600 transition-all hover:bg-rose-50 hover:border-rose-300 active:scale-95';
@endphp
                        ...
                        <div class="mb-6">
                            <div class="mb-4 flex items-start gap-3 rounded-lg bg-rose-50 p-4 border border-rose-100">
                                ...
                                <div class="text-sm text-rose-800">
                                    <p class="font-medium">Are you sure you want to cancel this {{ strtolower($entityName) }}?</p>
                            ...
                            <p class="mt-1 text-xs text-slate-500 font-medium">Please provide a brief explanation for this action.</p>
                        </div>
