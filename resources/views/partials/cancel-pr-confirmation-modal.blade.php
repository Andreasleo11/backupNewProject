<div x-data="{
    ...
    @open-cancel-pr-modal.window="open($event)" @keydown.escape.window="show = false" x-show="show"
    class="relative z-[100]" aria-labelledby="cancelPrModal" role="dialog" aria-modal="true" x-cloak>
        ...
        <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            <div x-show="show" @click.away="show = false" x-transition:enter="ease-out duration-300"
                ...
                <form :action="`/purchase-requests/${id}/cancel`" method="post" class="m-0">
                    ...
                    {{-- Premium Header --}}
                    <div
                        class="bg-gradient-to-r from-orange-50 to-white border-b border-orange-100 px-5 py-4 flex items-center justify-between">
                    ...
                    <div class="p-5 bg-slate-50 relative">
                        <div class="mb-2">
                            <label for="cancel-description"
                                class="form-label text-sm font-bold text-slate-700 mb-1 block">Reason for Cancellation
                                <span class="text-rose-500">*</span></label>
                            <p class="text-xs text-slate-500 mb-3">Please provide a clear reason why this PR (<span
                                    x-text="doc" class="font-bold text-slate-700"></span>) is being canceled.</p>
                    ...
                    <div
                        ...
                        <button type="submit"
                            class="bg-orange-500 hover:bg-orange-600 hover:shadow-lg hover:shadow-orange-200 text-white border-0 rounded-lg text-sm px-4 py-2 font-medium transition-all flex items-center gap-1.5 cursor-pointer">
