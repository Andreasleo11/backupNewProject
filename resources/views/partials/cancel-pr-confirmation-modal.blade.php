<div x-data="{
    ...
    @close-cancel-pr-modal.window="show = false"
                        ...
                        <form class="m-0" wire:submit.prevent>
                            ...
                            <div class="p-5 bg-slate-50 relative">
                                <div class="mb-2">
                                    ...
                                    <textarea id="cancel-description" cols="30" rows="4" x-model="reason"
                            ...
                            <div
                                ...
                                <button type="button" @click="$wire.cancelPurchaseRequest(id, reason)"
