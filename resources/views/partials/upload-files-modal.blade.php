...
<div class="modal fade" id="upload-files-modal" tabindex="-1" role="dialog" aria-labelledby="uploadFileModal" aria-hidden="true">
...
<script>
    ...
    inputFiles.addEventListener('change', function(){ document.getElementById('form-upload').submit(); })
</script>
