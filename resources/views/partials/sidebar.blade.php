  ...
  <ul class="sidebar-nav">
    ...
    @if ($department === 'COMPUTER' || $user->role->name === 'SUPERADMIN')
      <li class="sidebar-item" id="sidebar-item-computer">
        ...
        <ul id="computer" class="sidebar-dropdown list-unstyled collapse"
          data-bs-parent="#sidebar">
          <li class="sidebar-item">
    ...
    @if (
      ...
      <li class="sidebar-item" id="sidebar-item-qaqc">
        ...
        <ul id="qaqc" class="sidebar-dropdown list-unstyled collapse"
          data-bs-parent="#sidebar">
          <li class="sidebar-item">
    ...
    @if (
      ...
      <li class="sidebar-item" id="sidebar-item-production">
        ...
        <ul id="productionitem" class="sidebar-dropdown list-unstyled collapse"
          data-bs-parent="#sidebar">
          <li class="sidebar-item">
    ...
    @if ($department === 'BUSINESS' || $user->role->name === 'SUPERADMIN' || $department === 'PPIC')
      <li class="sidebar-item" id="sidebar-item-business">
        ...
        <ul id="businessitem" class="sidebar-dropdown list-unstyled collapse"
          data-bs-parent="#sidebar">
          <li class="sidebar-item">
    ...
    @endif
    @if (
        ($department === 'PERSONALIA' && auth()->user()->is_head === 1) ||
            $user->role->name === 'SUPERADMIN')
      <li class="sidebar-item" id="sidebar-item-hrd">
        ...
        <ul id="hrd" class="sidebar-dropdown list-unstyled collapse"
          data-bs-parent="#sidebar">
          <li class="sidebar-item" id="sidebar-item-hrd">
    ...
    @if ($specification === 'DIRECTOR')
      <li class="sidebar-item" id="sidebar-item-director">
        ...
        <ul id="director" class="sidebar-dropdown list-unstyled collapse"
          data-bs-parent="#sidebar">
          <li class="sidebar-item">
    ...
    @if ($department === 'PURCHASING' || $user->role->name === 'SUPERADMIN')
      <li class="sidebar-item" id="sidebar-item-purchasing">
        ...
        <ul id="purchasingitem" class="sidebar-dropdown list-unstyled collapse"
          data-bs-parent="#sidebar">
    ...
    @if ($department === 'ACCOUNTING' || $user->role->name === 'SUPERADMIN')
      <li class="sidebar-item" id="sidebar-item-accounting">
        ...
        <ul id="accountingitem" class="sidebar-dropdown list-unstyled collapse"
          data-bs-parent="#sidebar">
    ...
    @if (!$dashboardUser)
      <li class="sidebar-item" id="sidebar-item-list">
        ...
        <ul id="inventoryitem" class="sidebar-dropdown list-unstyled collapse"
          data-bs-parent="#sidebar">
          <li class="sidebar-item">
      ...
      <li class="sidebar-item" id="sidebar-item-list">
        ...
        <ul id="storeoption" class="sidebar-dropdown list-unstyled collapse"
          data-bs-parent="#sidebar">
          <li class="sidebar-list">
      ...
      <li class="sidebar-item" id="sidebar-item-stock-management">
        <a href="#" class="sidebar-link collapsed has-dropdown" data-bs-toggle="collapse"
          data-bs-target="#stock-management" aria-expanded="false"
          aria-controls="stock-management">
          <i class='bx bxs-component'></i>
          <span>Stock Management</span>
        </a>
        <ul id="stock-management" class="sidebar-dropdown list-unstyled collapse"
          data-bs-parent="#sidebar">
          <li class="sidebar-item">
            <a href="{{ route('mastertinta.index') }}" class="sidebar-link">
              <i class='bx bx-file'></i>
        ...
        <ul id="other" class="sidebar-dropdown list-unstyled collapse"
          ...
          <li class="sidebar-item">
            <a href="#" class="sidebar-link collapsed has-dropdown"
              data-bs-toggle="collapse" data-bs-target="#employee-evaluation-nested-dropdown"
              aria-expanded="false" aria-controls="employee-evaluation-nested-dropdown">
              <i class='bx bx-file'></i>
              <span>Employee Evaluation</span>
            </a>
            <ul id="employee-evaluation-nested-dropdown"
          ...
          <li class="sidebar-item">
            <a href="#" class="sidebar-link collapsed has-dropdown"
              data-bs-toggle="collapse" data-bs-target="#monthly-budget-nested-dropdown"
              aria-expanded="false" aria-controls="monthly-budget-nested-dropdown">
              <i class='bx bx-file'></i>
              <span>Monthly Budget</span>
            </a>
            <ul id="monthly-budget-nested-dropdown"
              class="sidebar-dropdown list-unstyled collapse">
              <li class="sidebar-item">
