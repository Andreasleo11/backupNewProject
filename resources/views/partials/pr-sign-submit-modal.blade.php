    ...
    <div class="flex min-h-full items-center justify-center p-4">
        <div class="relative w-full max-w-md transform overflow-hidden rounded-2xl bg-white shadow-2xl" @click.stop>
            ...
            <div class="bg-gradient-to-r from-indigo-600 to-violet-600 px-6 py-4 flex items-center justify-between">
                ...
                <button type="button" @click="open = false" class="rounded-lg p-1 text-white hover:bg-white/20">
            ...
            <div class="p-6">
                @if($hasDefaultSignature && $signaturePreviewUrl)
                    ...
                    <p class="text-sm text-slate-600 mb-4">
                        Your saved signature will be applied as the <strong>requester's signature</strong> on this request, and it will be submitted for approval immediately.
                    </p>

                    <div class="rounded-xl border border-slate-200 bg-slate-50 p-4 flex items-center justify-center min-h-[100px]">
                    ...
                    <p class="mt-3 text-xs text-slate-400 text-center">
                        Not your signature? <a href="{{ route('signatures.manage') }}" class="text-indigo-600 hover:underline">Manage signatures</a>
                    </p>
