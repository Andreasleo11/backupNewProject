<div class="modal" tabindex="-1" class="modal fade" id="edit-discipline-yayasan-modal-{{ str_replace(' ', '',$employee->id) }}" aria-labelledby="editModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            <form method="POST" action="{{route('updateyayasan', $employee->id)}}">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">Discipline Point For {{$employee->karyawan->Nama}} {{$employee->id}}</h5>
