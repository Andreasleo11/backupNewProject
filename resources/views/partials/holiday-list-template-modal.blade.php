        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
          <li class="nav-item" role="presentation">
            <button class="nav-link active" id="home-tab" data-bs-toggle="tab"
              ...
              aria-controls="home-tab-pane" aria-selected="true">Download</button>
          </li>
          <li class="nav-item" role="presentation">
          ...
          <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel"
            ...
            <div class="p-3 d-flex justify-content-center">
              <form action="{{ route('download.holiday.template') }}" method="GET">
                <button type="submit" class="btn btn-outline-primary mt-3">Download
                  Template</button>
              </form>
            </div>
          </div>
          <div class="tab-pane fade" id="profile-tab-pane" role="tabpanel"
            ...
            <div class="d-flex justify-content-center p-3">
              <form action="{{ route('upload.holiday.template') }}" method="POST"
                ...
                <button type="submit" class="btn btn-outline-primary ">Upload Filled
                  Template</button>
              </form>
            </div>
          </div>
