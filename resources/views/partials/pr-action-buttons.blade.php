        ...
        <template x-teleport="body">
            <div x-show="open" 
                ...
                <div class="px-2 pb-1 mb-1 border-bottom border-slate-50">
                    <span class="text-[9px] font-bold uppercase tracking-widest text-slate-400 px-2 leading-loose">General</span>
                </div>
                ...
                @if (!$pr->is_cancel)
                    @if(auth()->user()->can('cancel', $pr) || auth()->user()->can('delete', $pr))
                        ...
                        <div class="px-2 pb-1 mt-1">
                            <span class="text-[9px] font-bold uppercase tracking-widest text-slate-400 px-2 leading-loose">Danger Zone</span>
                        </div>
