    ...
    <div class="modal-content">
      <div class="modal-body">
        ...
        <div class="  px-2 py-5">
          ...
          <form action="{{ route('formovertime.update', $header->id) }}" method="POST"
            class="row " id="form-overtime-edit">
            @method('PUT')
            @csrf

            <div class="form-group mt-3 col">
              <label class="form-label fs-5 fw-bold" for="from_department">From Department</label>
              <select class="form-select" name="from_department" id="fromDepartmentDropdown"
                required>
            ...
            <div class="form-group mt-3 col-md-6">
              <label class="form-label fs-5 fw-bold" for="date_form_overtime">Date of Form Overtime
                Create</label>
              <input class="form-control" type="date" id="date_form_overtime"
                name="date_form_overtime" required value="{{ $header->create_date }}">
            </div>
