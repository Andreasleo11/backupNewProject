<div class="modal fade" id="add-fgwarehouse-modal-{{ $detail->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="POST" action="{{ route('fgwarehousesave') }}">
                    ...
                    <select id="fg_warehouse" name="fg_warehouse">
                    ...
                    @else
                        <label for="fg_warehouse">FG Warehouse:</label>
                    <select id="fg_warehouse" name="fg_warehouse">
                        <option value="{{$detail->fg_warehouse_name}}" selected>{{$detail->fg_warehouse_name}}</option>
                        <option value="01">01</option>
                        <option value="CFC">CFC</option>
                        <option value="CMS">CMS</option>
                        <option value="CMSO">CMSO</option>
