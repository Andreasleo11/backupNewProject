                ...
                <form action="{{ route('monthly-budget-summary-detail.update', $id) }}" 
                    ...
                    <div class="flex items-center justify-between border-b border-slate-100 px-6 py-4 bg-slate-50/80">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <h2 class="text-sm font-black text-slate-800 uppercase tracking-widest leading-none">Edit Item Detail</h2>
                                <p class="text-[10px] text-slate-400 font-bold uppercase tracking-tight mt-1">{{ $groupName }}</p>
                            </div>
                        </div>
                    ...
                    <div class="p-6 space-y-7 overflow-y-auto flex-1 text-left">
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            <div class="space-y-2">
                                <label class="block text-[10px] font-black text-slate-400 uppercase tracking-[0.1em] ml-1">Department No</label>
                                <div class="w-full rounded-xl border border-slate-100 bg-slate-50 px-4 py-3 text-xs font-bold text-slate-500">
                                    {{ $item['dept_no'] }}
                                </div>
                            </div>
                            <div class="space-y-2">
                                <label class="block text-[10px] font-black text-slate-400 uppercase tracking-[0.1em] ml-1">Item Name</label>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            <div class="space-y-2">
                                <label class="block text-[10px] font-black text-slate-400 uppercase tracking-[0.1em] ml-1">Quantity</label>
                                <input type="number" name="quantity" x-model="quantity" 
                                       class="w-full rounded-xl border-slate-200 text-xs font-bold text-slate-700 bg-white shadow-sm focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all px-4 py-3" 
                                       required>
                            </div>
                            <div class="space-y-2">
                                <label class="block text-[10px] font-black text-slate-400 uppercase tracking-[0.1em] ml-1">Unit of Measure (UoM)</label>
                        ...
                        @if ($item['dept_no'] == '363')
                            <div class="p-5 rounded-2xl bg-slate-50/50 border border-slate-100 space-y-5">
                                <div class="space-y-2">
                                    <label class="block text-[10px] font-black text-slate-400 uppercase tracking-[0.1em] ml-1">Specification</label>
                                ...
                                <div class="grid grid-cols-2 gap-6">
                                    <div class="space-y-2">
                                        <label class="block text-[10px] font-black text-slate-400 uppercase tracking-[0.1em] ml-1">Last Rec. Stock</label>
                                        <input type="number" name="last_recorded_stock" 
                                               class="w-full rounded-xl border-slate-200 text-xs font-bold text-slate-700 bg-white shadow-sm focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all px-4 py-3" 
                                               value="{{ $item['last_recorded_stock'] }}" required>
                                    </div>
                                    <div class="space-y-2">
                                        <label class="block text-[10px] font-black text-slate-400 uppercase tracking-[0.1em] ml-1">Usage / Month</label>
                        ...
                        <div class="space-y-2">
                            <label class="block text-[10px] font-black text-slate-400 uppercase tracking-[0.1em] ml-1">Supplier <span class="text-rose-500">*</span></label>
                            <input type="text" name="supplier" 
                                   class="w-full rounded-xl border-slate-200 text-xs font-bold text-slate-700 bg-white shadow-sm focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all px-4 py-3" 
                                   value="{{ $item['supplier'] }}" placeholder="Enter supplier name..." required>
                        </div>

                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 p-5 rounded-2xl bg-indigo-50/30 border border-indigo-100/50">
                            <div class="space-y-2">
                                <label class="block text-[10px] font-black text-indigo-600 uppercase tracking-[0.1em] ml-1">Cost Per Unit <span class="text-rose-500">*</span></label>
                            ...
                            <div class="space-y-2">
                                <label class="block text-[10px] font-black text-slate-400 uppercase tracking-[0.1em] ml-1">Subtotal (Preview)</label>
                        ...
                        <div class="space-y-2">
                            <label class="block text-[10px] font-black text-slate-400 uppercase tracking-[0.1em] ml-1">Remark / Reason</label>
                    ...
                    {{-- Footer --}}
                    <div class="flex items-center justify-end gap-3 border-t border-slate-100 px-6 py-5 bg-slate-50/80">
