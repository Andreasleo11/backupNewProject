...
<div x-data="{ open: false }" {{ '@' . $openEvent }}.window="open = true"
    ...
    <template x-teleport="body">
        <div x-show="open" x-cloak class="fixed inset-0 z-[100] overflow-y-auto" aria-labelledby="approve-modal-title"
                    ...
                    <form method="POST" action="{{ route($route, $id) }}" class="p-6">
                        ...
                        <div class="mb-6 space-y-4">
                            ...
                            <div class="flex items-start gap-3 rounded-lg bg-emerald-50 p-4 border border-emerald-100">
                                ...
                                <div class="text-sm text-emerald-800">
                                    ...
                                    <p class="mt-1 opacity-90">
                                        This will move the request to the next stage in the workflow. Your digital
                            ...
                            <div>
                                ...
                                <textarea id="approve-remarks" name="remarks" rows="3"
