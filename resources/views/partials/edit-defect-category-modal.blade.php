<div class="modal fade" tabindex="-1" class="modal fade" id="edit-defect-category-modal-{{ $defectCategory->id }}"
    aria-labelledby="editDefectCategoryModal" aria-hidden="true">
