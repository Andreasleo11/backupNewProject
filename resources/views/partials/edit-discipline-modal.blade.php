<div class="modal" tabindex="-1" class="modal fade"
  id="edit-discipline-modal-{{ str_replace(' ', '', $employee->id) }}"
        ...
        <div class="modal-body">
          <div class="form-group">
            <div class="row">
              ...
              <div class="col-sm-8">
                <input type="text" name="kerajinan_kerja" class="form-control"
                  id="kerajinan_kerja" pattern="[A-E]" maxlength="1"
                  value="{{ $employee->kerajinan_kerja }}" required
