...
<div x-data="{ open: false }" {{ '@' . $openEvent }}.window="open = true"
    x-effect="document.body.style.overflow = open ? 'hidden' : ''">
    <template x-teleport="body">
        <div x-show="open" x-cloak class="fixed inset-0 z-[100] overflow-y-auto" aria-labelledby="modal-title"
                ...
                <div class="relative w-full max-w-lg transform overflow-hidden rounded-2xl bg-white shadow-2xl transition-all"
                    ...
                    <form method="POST" action="{{ route($route, $id) }}" class="p-6">
                        ...
                        <div class="mb-6">
                            <div class="mb-4 flex items-start gap-3 rounded-lg bg-rose-50 p-4 border border-rose-100">
                                ...
                                <div class="text-sm text-rose-800">
                                    ...
                                    <p class="mt-1 text-rose-700">
                                        Please provide a clear reason for rejecting this {{ strtolower($entityName) }}.
                            ...
                            <textarea id="reject-remarks" name="remarks" rows="4" required
                            ...
                            <p class="mt-1 text-xs text-slate-500 font-medium">Please provide at least 10 characters.
                            </p>
                        </div>
