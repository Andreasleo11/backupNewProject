<div class="modal fade modal-lg" id="send-mail-modal" tabindex="-1" role="dialog" aria-labelledby="sendMailModal"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="{{ route('formadjust.report.sendEmail', $datas->id) }}" method="post"
                    ...
                    <div class="container mt-2">
                        ...
                        <div class="mt-3">
                            ...
                            @else
                                ...
                                <a href="{{ route('formadjust.savePdf', $datas->id) }}"
