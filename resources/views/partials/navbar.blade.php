      ...
      <div class="navbar navbar-collapse">
        ...
        <div class="dropdown-menu dropdown-menu-end px-3 mb-2">
          <div class="text-center">
            ...
            <span
              class="fw-medium text-secondary-emphasis">{{ Auth::user()->department->name }}</span>
          </div>
          <hr>
          <!--
          ...
          <form id="change-password-form" action="{{ route('change.password.show') }}"
            method="get" class="d-none"> @csrf </form>
