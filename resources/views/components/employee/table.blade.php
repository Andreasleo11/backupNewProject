            ...
            <tbody class="divide-y divide-slate-100 bg-white">
                @forelse ($employees as $employee)
                    <tr class="hover:bg-slate-50/50 transition-colors group">
                        ...
                        <td class="px-6 py-3 whitespace-nowrap">
                            <span class="inline-flex items-center px-3 py-0.5 rounded-lg text-[10px] font-bold uppercase tracking-wider {{ $employee->branch === 'JAKARTA' ? 'bg-indigo-50 text-indigo-700 border border-indigo-100' : 'bg-purple-50 text-purple-700 border border-purple-100' }}">
                        ...
                        <td class="px-6 py-3 whitespace-nowrap text-[10px] font-bold text-slate-500 uppercase tracking-tight">
                        ...
                        <td class="px-6 py-3 whitespace-nowrap text-[11px] font-medium text-slate-500">
                            ...
                            <span class="text-[9px] font-black text-slate-400 uppercase ml-1 px-1.5 py-0.5 bg-slate-50 rounded border border-slate-100">{{ $employee->grade_level }}</span>
                        </td>
                    </tr>
                @empty
                    <tr>
