<div>
    <form action="{{ $action }}" method="POST" class="space-y-5">
        ...
        <div class="space-y-1">
            ...
            <input type="date" name="last_training_at" id="last_training_at"
        ...
        <div class="space-y-1">
            ...
            <div class="flex items-center gap-6 mt-1 text-sm">
                <label class="inline-flex items-center gap-2">
                    <input class="w-4 h-4 border-slate-300 text-indigo-600 focus:ring-indigo-500" type="radio"
                        name="evaluated" id="evaluated_yes" value="1"
                ...
                <label class="inline-flex items-center gap-2">
                    <input class="w-4 h-4 border-slate-300 text-indigo-600 focus:ring-indigo-500" type="radio"
                        name="evaluated" id="evaluated_no" value="0"
