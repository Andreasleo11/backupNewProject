    ...
    <form action="{{ route('masterinventory.update', $data->id) }}" method="POST"
      ...
      <div class="form-group">
        ...
        <input type="text" name="ip_address" id="ip_address" class="form-control"
          value="{{ $data->ip_address }}" required>
      </div>
            ...
            <tr data-index="{{ $index }}">
              ...
              <td>
                <input type="text" name="hardwares[{{ $index }}][brand]"
                  class="form-control" value="{{ $hardware->brand }}" required>
              </td>
              <td>
              ...
              <td>
                <input type="text" name="hardwares[{{ $index }}][remark]"
                  class="form-control" value="{{ $hardware->remark }}" required>
              </td>
              <td>
            ...
            <tr data-index="{{ $index }}">
              ...
              <td>
                <input type="text" name="softwares[{{ $index }}][remark]"
                  class="form-control" value="{{ $software->remark }}" required>
              </td>
              <td>
