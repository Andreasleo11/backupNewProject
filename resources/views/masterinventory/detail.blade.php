...
@section('content')
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6" x-data="{ tab: 'hardware', repairModal: false }">
        {{-- Header + actions --}}
            ...
            <div class="px-4 py-4 sm:px-6 sm:py-5">
                ...
                <div class="flex flex-col md:flex-row gap-6">
                    ...
                    <div class="md:w-64">
                        ...
                        <div
                            class="border border-dashed border-gray-200 rounded-md p-2 flex items-center justify-center bg-slate-50">
                            @if ($data->position_image)
                                <a href="{{ asset('storage/' . $data->position_image) }}" data-fancybox="gallery"
                                    data-caption="Position Image" class="block">
        ...
        <div>
            <div class="border-b border-gray-200 mb-3">
                <nav class="-mb-px flex flex-wrap gap-2" aria-label="Tabs">
                    <button type="button" @click="tab = 'hardware'"
                        :class="tab === 'hardware'
                            ?
                    ...
                    <button type="button" @click="tab = 'software'"
                        :class="tab === 'software'
                            ?
                            'border-indigo-500 text-indigo-600' :
                            'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'"
                    ...
                    <button type="button" @click="tab = 'repair'"
                        :class="tab === 'repair'
                            ?
                            'border-indigo-500 text-indigo-600' :
                            'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'"
                    ...
                    <button type="button" @click="tab = 'maint'"
                        :class="tab === 'maint'
                            ?
                            'border-indigo-500 text-indigo-600' :
                            'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'"
                                ...
                                <table class="min-w-full divide-y divide-gray-200 text-xs sm:text-sm">
                                    <thead class="bg-gray-50">
                                        <tr>
                                            ...
                                            <th class="px-3 py-2 text-left font-semibold text-gray-600">Nomor Inventaris
                                            </th>
                                            <th class="px-3 py-2 text-left font-semibold text-gray-600">Hardware Name</th>
                                            <th class="px-3 py-2 text-left font-semibold text-gray-600">Tanggal Pembelian
                                            </th>
                ...
                <div class="bg-white rounded-lg shadow-sm ring-1 ring-gray-200">
                    <div class="px-4 py-4 sm:px-6 sm:py-5">
                        <div class="flex items-center justify-between mb-3">
                            ...
                            <button type="button" @click="repairModal = true"
                                class="inline-flex items-center rounded-md bg-indigo-600 px-3 py-1.5 text-xs font-semibold text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-1 focus:ring-indigo-500">
        ...
        <div x-show="repairModal" x-cloak
            ...
            <div class="relative w-full max-w-lg rounded-lg bg-white shadow-lg ring-1 ring-gray-200">
                <div class="flex items-center justify-between border-b border-gray-200 px-4 py-3 sm:px-6">
                    ...
                    <button type="button" @click="repairModal = false"
                        ...
                        <div id="installationFields" style="display: none;">
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <select
                                        class="mt-1 block w-full rounded-md border-gray-300 bg-slate-50 px-3 py-2 text-sm shadow-sm
                                                   focus:bg-white focus:border-indigo-500 focus:ring-indigo-500"
                                        id="itemTypeInstallation" name="itemTypeInstallation">
                                        <option value="">Select Item Type</option>
                                    </select>
                                </div>
                                <div>
                                    ...
                                    <input type="text"
                                        class="mt-1 block w-full rounded-md border-gray-300 bg-slate-50 px-3 py-2 text-sm shadow-sm
                                                  focus:bg-white focus:border-indigo-500 focus:ring-indigo-500"
                                        id="itemBrandInstallation" name="itemBrandInstallation">
                                </div>
                            </div>
                            ...
                            <div class="mt-3">
                                ...
                                <input type="text"
                                    class="mt-1 block w-full rounded-md border-gray-300 bg-slate-50 px-3 py-2 text-sm shadow-sm
                                              focus:bg-white focus:border-indigo-500 focus:ring-indigo-500"
                                    id="itemNameInstallation" name="itemNameInstallation">
                            </div>
                        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function loadOldParts() {
                ...
                if (type && masterId) {
                    fetch(
                            `/items/available?type=${encodeURIComponent(type)}&master_id=${encodeURIComponent(masterId)}`)
