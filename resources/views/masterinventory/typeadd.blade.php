...
<div class="container">
    ...
    <div class="d-flex justify-content-between mb-3">
        ...
        <button class="btn btn-primary" data-toggle="modal" data-target="#addHardwareTypeModal">Add Hardware Type</button>
    </div>
            ...
            <tbody>
                @forelse($hardwareTypes as $type)
                    <tr>
                        <td>{{ $type->name }}</td>
                        <td>
                        <button class="btn btn-danger btn-sm delete-btn" data-id="{{ $type->id }}" data-type="hardware">Delete</button>
                    </td>
                    </tr>
                @empty
                    <tr>
    ...
    <div class="d-flex justify-content-between mb-3">
        ...
        <button class="btn btn-primary" data-toggle="modal" data-target="#addSoftwareTypeModal">Add Software Type</button>
    </div>
    <div class="table-responsive">
        <table class="table table-striped table-bordered">
            <thead class="thead-dark">
            ...
            <tbody>
                @forelse($softwareTypes as $type)
                    <tr>
                        <td>{{ $type->name }}</td>
                        <td>
                    <button class="btn btn-danger btn-sm delete-btn" data-id="{{ $type->id }}" data-type="software">Delete</button>
                </td>
                    </tr>
                @empty
                    <tr>
...
<div class="modal fade" id="addHardwareTypeModal" tabindex="-1" role="dialog" aria-labelledby="addHardwareTypeModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                <form id="addHardwareTypeForm">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="hardwareTypeName" name="name" required>
                    </div>
...
<div class="modal fade" id="addSoftwareTypeModal" tabindex="-1" role="dialog" aria-labelledby="addSoftwareTypeModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form id="addSoftwareTypeForm">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="softwareTypeName" name="name" required>
                    </div>
                    <button type="submit" class="btn btn-primary">Add Type</button>
                </form>
            </div>
