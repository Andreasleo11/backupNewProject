                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('pt.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="dept" class="form-control @error('dept') is-invalid @enderror" name="dept" required>
                        ...
                        <div class="form-group row">
                            <label for="request_date" class="col-md-4 col-form-label text-md-right">{{ __('Request Date') }}</label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="pic" type="text" class="form-control @error('pic') is-invalid @enderror" name="pic" value="{{ old('pic') }}" required autocomplete="pic">
