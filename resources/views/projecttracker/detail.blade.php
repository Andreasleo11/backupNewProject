...
@section('content')
  ...
  <div class="container">
    <div class="card">
      ...
      @if ($project->status == 'OnGoing')
        <div class="progress" role="progressbar" aria-valuenow="20" aria-valuemin="0"
  ...
  @else
    @foreach ($histories as $history)
      <p><strong>Date:</strong> {{ $history->date }} &nbsp;&nbsp; <strong>Status:</strong>
        {{ $history->status }} &nbsp;&nbsp; <strong>Remark:</strong> {{ $history->remarks }}</p>
    @endforeach
  @endif
  ...
  @if ($project->status == 'ReadyToTest')
    ...
    <button class="btn btn-danger btn-lg me-4" data-bs-toggle="modal"
      data-bs-target="#rejectModal">Revision</button>
