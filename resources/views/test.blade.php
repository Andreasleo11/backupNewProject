                ...
                <div class="employee-info">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <p><strong>Start Date:</strong> {{ \Carbon\Carbon::parse($user->start_date)->format('d M Y') }}
                            </p>
                ...
                <div class="assessment-table">
                    ...
                    <style>
                        .assessment-table table {
                            ...
                            /* Atur ukuran font */
                            margin: 0 auto;
                            /* Tabel akan terletak di tengah */
                            margin-top: 0;
                            /* Mengurangi margin atas */
                            margin-bottom: 10px;
                            /* Menambahkan margin bawah jika perlu */
                        }
                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                <th rowspan="2">Assessment Area</th>
                                <th rowspan="2">Aspect</th>
                                <th colspan="5">Score <br>(lingkari atau coret nilai)</th>
                            </tr>
                            <tr>
                                <th>A</th> <!-- Menambahkan kolom A -->
                                <th>B</th> <!-- Menambahkan kolom B -->
                                <th>C</th> <!-- Menambahkan kolom C -->
                                <th>D</th> <!-- Menambahkan kolom D -->
                                <th>E</th> <!-- Menambahkan kolom E -->
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
