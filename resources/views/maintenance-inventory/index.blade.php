...
@section('content')
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <button type="button" class="btn btn-primary" data-bs-toggle="modal"
        data-bs-target="#usernameStatusModal">
        ...
        <div class="row mb-3">
          <div class="col-md-3">
            ...
            <select name="periode" id="periode" class="form-select">
              ...
              <option value="1" {{ request('periode') == 1 ? 'selected' : '' }}>1 (Januari -
                April)</option>
              <option value="2" {{ request('periode') == 2 ? 'selected' : '' }}>2 (Mei - Agustus)
              </option>
              <option value="3" {{ request('periode') == 3 ? 'selected' : '' }}>3 (September -
                Desember)</option>
            </select>
          </div>
          <div class="col-md-3">
  ...
  <div class="modal fade" id="usernameStatusModal" tabindex="-1"
    aria-labelledby="usernameStatusModalLabel" aria-hidden="true">
