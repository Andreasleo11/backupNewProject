    ...
    <div class="container">
        <div class="row mb-3">
            ...
            <div class="col text-end">
                <button class="btn btn-primary btn-sm" data-bs-target="#add-permission-modal" data-bs-toggle="modal">+ Add
                    Permission</button>
            </div>
        </div>
                    ...
                    @foreach ($permissions as $permission)
                        <tr>
                            ...
                            <td>
                                ...
                                <button data-bs-target="#edit-permission-modal-{{ $permission->id }}" data-bs-toggle="modal"
                                ...
                                @include('partials.delete-confirmation-modal', [
                                    ...
                                    'body' =>
                                        'Are you sure want to delete <strong>' . $permission->name . '</strong>?',
                                ])
