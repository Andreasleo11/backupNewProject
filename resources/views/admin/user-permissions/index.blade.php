                                                                ...
                                                                @foreach ($permissions as $permission)
                                                                    @php
                                                                        if (strpos($permission->name, 'get-') === 0) {
                                                                            ...
                                                                            strpos($permission->name, 'edit-') === 0
                                                                        ) {
                                                                            $badgeClass = 'custom-third-color';
                                                                        } elseif (
                                                                            strpos($permission->name, 'delete-') === 0
                                                                        ) {
                                                                            $badgeClass = 'custom-first-color';
                                                                        } elseif (
                                                                            strpos($permission->name, 'update-') === 0
                                                                        ) {
                                                                            $badgeClass = 'custom-fourth-color';
                                                                        } elseif (
                                                                            strpos($permission->name, 'store-') === 0
                                                                        ) {
                                                                            $badgeClass = 'custom-fifth-color';
                                                                        } elseif (
                                                                            strpos($permission->name, 'create-') === 0
                                                                        ) {
