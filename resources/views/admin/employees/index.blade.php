...
<div class="space-y-6">
    ...
    <div class="mb-8 space-y-6">
        <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
            ...
            <div class="w-full lg:max-w-2xl grid grid-cols-2 sm:grid-cols-4 gap-3 lg:gap-4">
                @php
                    $stats = [
                        ['label' => 'Total', 'value' => $this->globalStats['total'], 'icon' => 'group', 'color' => 'blue', 'info' => 'Total active personnel'],
                        ['label' => 'Perm', 'value' => $this->globalStats['permanent'], 'icon' => 'shield', 'color' => 'emerald', 'info' => 'Inc. Tetap/Asing/Manajemen'],
                        ['label' => 'Cntrt', 'value' => $this->globalStats['contract'], 'icon' => 'file', 'color' => 'amber', 'info' => 'Inc. Kontrak/Magang'],
                        ['label' => 'KRWG', 'value' => $this->globalStats['karawang'], 'icon' => 'map-pin', 'color' => 'purple', 'info' => 'Personnel assigned to Karawang Hub'],
                    ];
                @endphp
    ...
    <x-employee.modals 
        ...
        :preview-search="$previewSearch"
    />

    {{-- 5. Persistent Drawer (Teleport to Body) --}}
    <x-employee.audit-drawer 
