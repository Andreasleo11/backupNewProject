    ...
    <div class="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm sm:p-6">
        ...
        @else
            ...
            <div class="rounded-2xl border border-slate-200 bg-slate-50 p-4" wire:key="upload-mode">
                ...
                <div class="mt-4">
                    <div
                        class="relative flex min-h-[220px] flex-col items-center justify-center rounded-2xl border-2 border-dashed border-slate-300 bg-white p-6 transition hover:border-indigo-400">
                        @if ($signatureImage)
                        ...
                        @else
                            ...
                            <div class="flex flex-col items-center">
                                ...
                                <span class="text-sm font-semibold text-slate-900">Click to upload or drag and
                                    drop</span>
                        ...
                        {{-- Loading Indicator --}}
                        <div wire:loading wire:target="signatureImage"
