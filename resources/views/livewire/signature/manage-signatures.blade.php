<div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8" x-data="{}">
    ...
    @if (session('onboarding_signature'))
        <div class="mb-8 overflow-hidden rounded-3xl bg-indigo-600 shadow-lg shadow-indigo-200" x-data="{ show: true }"
            ...
            <div class="relative px-6 py-8 sm:px-12 sm:py-10">
                ...
                <div class="relative flex flex-col items-center gap-6 sm:flex-row sm:gap-10">
                    <div
                        class="flex h-20 w-20 shrink-0 items-center justify-center rounded-2xl bg-white/10 text-white ring-1 ring-white/20 backdrop-blur-md">
                        {{-- pen icon --}}
                    ...
                    <div class="flex-1 text-center sm:text-left">
                        ...
                        <p class="mt-2 text-lg text-indigo-100/90 leading-relaxed">
                            Your role is vital for official approvals. To make it official, we need your <span
                                class="font-semibold text-white">digital signature</span> on file.
                    ...
                    <div class="shrink-0">
                        <button type="button" x-on:click="show = false"
                            class="rounded-xl bg-white/10 px-4 py-2 text-sm font-semibold text-white transition hover:bg-white/20 focus:outline-none">
                            Got it!
                        </button>
                    </div>
                </div>
    ...
    @push('modals')
        <div x-data="{
            ...
            "
            x-on:keydown.escape.window="revokeOpen = false" x-cloak>
            ...
            <template x-teleport="body">
                <div x-show="revokeOpen" class="fixed inset-0 z-[100] flex items-center justify-center"
                    ...
                    {{-- Backdrop --}}
                    <div class="absolute inset-0 bg-slate-900/50 backdrop-blur-sm" x-on:click="revokeOpen = false"
                    ...
                    <div class="relative w-full max-w-lg rounded-2xl bg-white shadow-2xl ring-1 ring-black/5"
                        x-show="revokeOpen" x-transition:enter="transition ease-out duration-300"
                        ...
                        <div class="flex items-center justify-between border-b border-slate-200 px-6 py-5">
                            ...
                            <button type="button"
                                class="rounded-xl p-2 text-slate-400 hover:bg-slate-100 hover:text-slate-700 transition-all duration-200"
                        ...
                        <div class="px-6 py-10 text-center">
                            <div
                                class="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-2xl bg-rose-50 text-rose-600 ring-4 ring-rose-50/50 transition-transform duration-500 hover:scale-110">
                            ...
                            <h3 id="revoke-title" class="text-xl font-extrabold text-slate-900 tracking-tight">Revoke this
                                signature?</h3>
                            <p class="mt-3 text-sm text-slate-500 leading-relaxed max-w-[280px] mx-auto">
                                This action is permanent. Once revoked, this signature will be <span
                                    class="text-rose-600 font-bold underline decoration-rose-200 underline-offset-4">deactivated
                                    forever</span>.
                            </p>

                            <div
                                class="mt-8 rounded-2xl border border-slate-100 bg-slate-50/30 p-5 text-left backdrop-blur-sm">
                                <div class="grid grid-cols-2 gap-6">
                                    <div class="space-y-1">
                                        <p class="text-[10px] font-black text-slate-400 uppercase tracking-widest">Target
                                            Label</p>
                                        <p class="text-[13px] font-bold text-slate-800" x-text="revokeLabel"></p>
                                    </div>
                                    <div class="space-y-1">
                                        <p class="text-[10px] font-black text-slate-400 uppercase tracking-widest">Internal
                                            ID</p>
                        ...
                        <div
                            class="flex flex-col sm:flex-row items-center justify-stretch gap-3 border-t border-slate-100 bg-slate-50/50 px-6 py-6 rounded-b-2xl">
                            <button type="button"
