            ...
            <form wire:submit.prevent="save">
                <div class="mb-3">
                    ...
                    <input type="text" wire:model.defer="plate_number"
                        class="form-control @error('plate_number') is-invalid @enderror" placeholder="e.g. B 1234 ABC">
                    @error('plate_number')
                ...
                <div class="mb-4">
                    ...
                    <input type="text" wire:model.defer="driver_name"
                        class="form-control @error('driver_name') is-invalid @enderror" placeholder="e.g. John Doe">
                    @error('driver_name')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
