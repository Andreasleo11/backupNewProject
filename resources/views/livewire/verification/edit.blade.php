                        ...
                        <table class="table align-middle">
                            ...
                            <tbody>
                                @forelse($items as $i => $row)
                                    ...
                                    {{-- Add below the item inputs, inside the <tr> or as a second row --}}
                                    <tr>
                                        <td colspan="8" class="bg-light">
                                            <div class="d-flex justify-content-between align-items-center">
                                                ...
                                                <button class="btn btn-sm btn-outline-primary" type="button"
                                                    ...
                                                    <i class="bi bi-search"></i> Add from catalog
                                                </button>
                                            </div>

                                            @php $defects = $items[$i]['defects'] ?? []; @endphp
                                            @if (empty($defects))
                                                <div class="text-muted small py-2">No defects.</div>
                                            @else
                                                        ...
                                                        <tbody>
                                                            @foreach ($defects as $d => $def)
                                                                <tr>
                                                                    <td>
                                                                        <input type="text"
                                                                            class="form-control @error('items.' . $i . '.defects.' . $d . '.code') is-invalid @enderror"
                                                                    ...
                                                                    <td>
                                                                        <input type="text"
                                                                            class="form-control @error('items.' . $i . '.defects.' . $d . '.name') is-invalid @enderror"
                                                                    ...
                                                                    <td>
                                                                        <select
                                                                            class="form-select @error('items.' . $i . '.defects.' . $d . '.severity') is-invalid @enderror"
                                                                    ...
                                                                    <td>
                                                                        <select
                                                                            class="form-select @error('items.' . $i . '.defects.' . $d . '.source') is-invalid @enderror"
                                                                    ...
                                                                    <td>
                                                                        <input type="number" step="0.0001"
                                                                            class="form-control text-end @error('items.' . $i . '.defects.' . $d . '.quantity') is-invalid @enderror"
                                                                    ...
                                                                    <td>
                                                                        <input type="text"
                                                                            class="form-control @error('items.' . $i . '.defects.' . $d . '.notes') is-invalid @enderror"
                                ...
                                <tbody>
                                    @forelse($catalogResults as $c)
                                        <tr>
                                            ...
                                            <td>{{ $c['name'] }}</td>
                                            <td>@include('partials.severity-badge', ['severity' => $c['severity']])</td>
                                            <td>@include('partials.source-chip', ['source' => $c['source']])</td>
                                            <td class="text-end">
                                                {{ rtrim(rtrim(number_format($c['quantity'], 4, '.', ''), '0'), '.') }}</td>
                                            <td class="text-end">
                                                <button class="btn btn-sm btn-primary"
                                                    wire:click="pickCatalogDefect({{ $c['id'] }})">
                                                    Use
                                                </button>
                                            </td>
                                        </tr>
