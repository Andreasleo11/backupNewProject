...
<div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8 space-y-8" x-data="{ showFilters: false }">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div class="relative overflow-hidden rounded-3xl border border-slate-200 bg-white p-6 shadow-sm transition-all hover:shadow-md group">
            <div class="absolute right-0 top-0 -mr-4 -mt-4 h-20 w-20 rounded-full bg-indigo-50 transition-transform group-hover:scale-110"></div>
            <div class="relative flex items-center justify-between">
                <div>
                    <h3 class="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Kepatuhan Tim Hari Ini</h3>
                    <div class="mt-2 flex items-baseline gap-2">
                        ...
                        <div class="flex h-1.5 w-24 rounded-full bg-slate-100 overflow-hidden">
                            <div class="h-full bg-indigo-500 rounded-full" style="width: {{ $this->teamStats['rate'] }}%"></div>
                        </div>
                    </div>
                </div>
        ...
        <div class="relative overflow-hidden rounded-3xl border border-slate-200 bg-white p-6 shadow-sm transition-all hover:shadow-md group">
            <div class="absolute right-0 top-0 -mr-4 -mt-4 h-20 w-20 rounded-full bg-emerald-50 transition-transform group-hover:scale-110"></div>
            <div class="relative flex items-center justify-between">
                <div>
                    <h3 class="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Laporan Masuk</h3>
                    <div class="mt-2 text-3xl font-black text-slate-900">{{ $this->teamStats['submitted'] }} <span class="text-sm font-semibold text-slate-500">Karyawan</span></div>
                </div>
        ...
        <div class="relative overflow-hidden rounded-3xl border border-slate-200 bg-white p-6 shadow-sm transition-all hover:shadow-md group">
            <div class="absolute right-0 top-0 -mr-4 -mt-4 h-20 w-20 rounded-full bg-slate-50 transition-transform group-hover:scale-110"></div>
            <div class="relative flex items-center justify-between">
                <div>
                    <h3 class="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Total Karyawan</h3>
                    <div class="mt-2 text-3xl font-black text-slate-900">{{ $this->teamStats['total'] }} <span class="text-sm font-semibold text-slate-500">Orang</span></div>
                </div>
