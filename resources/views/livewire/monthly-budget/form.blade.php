    ...
    <div class="bg-white/70 backdrop-blur-xl border border-white/40 rounded-2xl shadow-xl overflow-hidden relative">
        ...
        <div class="p-6 sm:p-8">
            <div class="space-y-8">
                ...
                <div x-show="!$wire.useExcel" 
                     x-transition:enter="transition ease-out duration-300 transform"
                     x-transition:enter-start="opacity-0 translate-y-4"
                     x-transition:enter-end="opacity-100 translate-y-0"
                     class="space-y-6 pt-4 border-t border-slate-50">
                                ...
                                @forelse ($items as $index => $item)
                                    <tr class="group hover:bg-slate-50/50 transition-colors">
                                        ...
                                        <td class="px-4 py-3">
                                            ...
                                            @error("items.{$index}.uom") <p class="text-[9px] text-rose-500 font-bold mt-1 uppercase">{{ $message }}</p> @enderror
                                        </td>
                                        @if($this->isDept363)
                                        ...
                                        <td class="px-4 py-3 text-center">
                                            ...
                                            @error("items.{$index}.quantity") <p class="text-[9px] text-rose-500 font-bold mt-1 uppercase">{{ $message }}</p> @enderror
                                        </td>
                                        <td class="px-4 py-3">
                                    ...
                                    <tr>
                                        <td colspan="10" class="px-6 py-20 text-center">
                                            <div class="flex flex-col items-center gap-4">
                                                <div class="h-16 w-16 rounded-3xl bg-slate-50 flex items-center justify-center text-slate-200 group-hover:scale-110 transition-transform duration-500">
                                                    <i class="bx bx-receipt text-3xl"></i>
                                                </div>
                                                <div class="space-y-1">
                                                    <p class="text-[11px] font-black text-slate-300 uppercase tracking-widest">No items added yet</p>
                                                    <p class="text-[10px] text-slate-400 font-medium uppercase tracking-tighter italic">Click "Add Item" to start your budget request</p>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
