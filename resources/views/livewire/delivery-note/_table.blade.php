<table class="min-w-full divide-y divide-slate-200 text-sm">
    <thead class="bg-slate-50">
        <tr>
            ...
            {{-- Branch --}}
            <th scope="col" wire:click="sortBy('branch')"
                class="px-3 py-2 text-left text-xs font-semibold uppercase tracking-wide text-slate-500 cursor-pointer select-none">
                <div class="inline-flex items-center gap-1">
                    <span>Branch</span>
                    @if ($sortField === 'branch')
            ...
            {{-- Ritasi --}}
            <th scope="col" wire:click="sortBy('ritasi')"
                class="px-3 py-2 text-left text-xs font-semibold uppercase tracking-wide text-slate-500 cursor-pointer select-none">
                <div class="inline-flex items-center gap-1">
                    <span>Ritasi</span>
                    @if ($sortField === 'ritasi')
            ...
            {{-- Date --}}
            <th scope="col" wire:click="sortBy('delivery_note_date')"
                class="px-3 py-2 text-left text-xs font-semibold uppercase tracking-wide text-slate-500 cursor-pointer select-none">
                <div class="inline-flex items-center gap-1">
                    <span>Date</span>
            ...
            {{-- Vehicle --}}
            <th scope="col" wire:click="sortBy('plate_number')"
                class="px-3 py-2 text-left text-xs font-semibold uppercase tracking-wide text-slate-500 cursor-pointer select-none">
                <div class="inline-flex items-center gap-1">
                    <span>Vehicle</span>
            ...
            {{-- Driver --}}
            <th scope="col" wire:click="sortBy('driver_name')"
                class="px-3 py-2 text-left text-xs font-semibold uppercase tracking-wide text-slate-500 cursor-pointer select-none">
                <div class="inline-flex items-center gap-1">
                    <span>Driver</span>
