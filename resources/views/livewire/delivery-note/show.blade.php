    ...
    <table class="table table-bordered mt-3">
      ...
      <tbody>
        ...
        @php
          ...
          $balikanCurrencies = $deliveryNote->destinations
              ->pluck('balikan_cost_currency')
              ->unique();
          ...
          $totalBalikanCost = $canSumBalikan
              ? $deliveryNote->destinations->sum('balikan_cost')
              : null;
        @endphp
          ...
          <td>
            ...
            @else
              <span class="text-danger"
                title="Multiple currencies detected, cannot calculate total">Mixed
                currency</span>
            @endif
          </td>
          <td>
