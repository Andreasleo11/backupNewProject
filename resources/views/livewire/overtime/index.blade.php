...
<div x-data x-init="$nextTick(() => {
    ...
    <div class="card-body">
      ...
      <div class="d-flex flex-wrap gap-2 align-items-center">
        ...
        <div class="btn-group d-none d-md-inline-flex" role="group" aria-label="Quick ranges">
          <button type="button"
            class="btn btn-outline-secondary {{ $range === 'today' ? 'active' : '' }}"
            aria-pressed="{{ $range === 'today' ? 'true' : 'false' }}"
            wire:click="setRange('today')">Today</button>

          <button type="button"
            class="btn btn-outline-secondary {{ $range === '7d' ? 'active' : '' }}"
            aria-pressed="{{ $range === '7d' ? 'true' : 'false' }}"
            wire:click="setRange('7d')">Last 7
            days</button>

          <button type="button"
            class="btn btn-outline-secondary {{ $range === '30d' ? 'active' : '' }}"
            aria-pressed="{{ $range === '30d' ? 'true' : 'false' }}"
            wire:click="setRange('30d')">Last 30
            days</button>

          <button type="button"
            class="btn btn-outline-secondary {{ $range === 'mtd' ? 'active' : '' }}"
        ...
        <div class="ms-auto d-flex align-items-center gap-2">
          {{-- Per-page --}}
          <select class="form-select form-select" style="max-width: 120px"
          ...
          <div class="btn-group ms-1" role="group" aria-label="Density">
            <input type="radio" class="btn-check" id="denseOn" name="density"
              value="1" wire:model.live="dense">
            <label class="btn btn-outline-secondary btn" for="denseOn" data-bs-toggle="tooltip"
              title="Compact rows">
              <i class="bi bi-list"></i>
            </label>

            <input type="radio" class="btn-check" id="denseOff" name="density"
              value="0" wire:model.live="dense">
      ...
      <div class="row g-3 align-items-end mt-3 d-none d-md-flex">
        <div class="col-auto">
          ...
          <input id="start_date" type="date" class="form-control shadow-sm"
            wire:model.live="startDate" placeholder=" ">
          @error('startDate')
        ...
        <div class="col-auto">
          ...
          <input id="end_date" type="date" class="form-control shadow-sm"
            wire:model.live="endDate" placeholder=" ">
          @error('endDate')
            <div class="text-danger small mt-1">{{ $message }}</div>
          @enderror
        </div>
  ...
  <div x-data="{
    ...
    <div class="modal fade" id="deleteModal" x-ref="modal" tabindex="-1"
