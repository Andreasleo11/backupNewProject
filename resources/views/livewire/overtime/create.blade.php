  ...
  <form wire:submit.prevent="submit" enctype="multipart/form-data">
    <div class="bg-white p-4 rounded shadow-sm border">
      ...
      <div class="row g-4 mb-4">
        <div class="col">
          <label for="dept_id" class="form-label">From Department <span
        ...
        @if ($dept_id && optional($departements->firstWhere('id', $dept_id))->name === 'MOULDING')
          <div class="col">
            <label for="design" class="form-label">Design <span
                class="text-danger">*</span></label>
    ...
    <div class="bg-white p-4 rounded shadow-sm border mt-4">
      ...
      <div class="mb-4">
        ...
        <div class="row g-2">
          <div class="col-md-6">
            <div
              class="{{ $cardBase }} {{ !$isExcelMode ? 'border-primary bg-primary-subtle ' : '' }}"
          ...
          <div class="col-md-6">
            <div
              class="{{ $cardBase }} {{ $isExcelMode ? 'border-success bg-success-subtle' : '' }}"
      ...
      @if ($isExcelMode)
        <div class="mb-4" wire:key="excel-mode">
          ...
          <input wire:model="excel_file" type="file" class="form-control shadow-sm"
            accept=".xlsx,.xls">
          @error('excel_file')
            <small class="text-danger">{{ $message }}</small>
          @enderror
      ...
      @else
        <div class="card border shadow-sm mb-4" wire:key="manual-mode">
          <div class="card-body">
            ...
            @endforeach
            <button wire:click.prevent="addItem" type="button"
