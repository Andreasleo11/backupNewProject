<div class="max-w-6xl mx-auto px-4 py-6">
    ...
    <div class="mb-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div class="flex flex-wrap items-center gap-3">
            <div class="relative">
                <input type="text" wire:model.live.debounce.400ms="search" placeholder="Search name or email..."
            ...
            <label class="inline-flex items-center gap-2 text-xs text-slate-600">
                <input type="checkbox" wire:model.live.debounce.400ms="onlyActive"
                    class="h-4 w-4 rounded border-slate-300 text-indigo-600 focus:ring-indigo-500">
                Active only
            </label>

            <select wire:model.live.debounce.400ms="perPage"
                class="rounded-lg border border-slate-200 bg-white px-2 py-1 text-xs shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500">
    ...
    {{-- Users table --}}
    <div class="max-w-6xl mx-auto rounded-xl border border-slate-200 bg-white shadow-sm">
                        ...
                        <tr class="hover:bg-slate-50/60" wire:key="user-row-{{ $user->id }}">
                            ...
                            <td class="px-4 py-3 text-right">
                                <div class="inline-flex items-center gap-1">
                                    ...
                                    <button type="button" wire:click="openPasswordModal({{ $user->id }})"
        ...
        @if ($users->hasPages())
            {{-- 
                <div
                    class="flex items-center justify-between border-t border-slate-100 bg-slate-50 px-4 py-3 text-xs text-slate-600">
                    <div>
                        Showing
    ...
    <div x-data="{ openModal: @entangle('showModal').live }">
        {{-- Modal backdrop --}}
        <div class="fixed inset-0 z-40 bg-black/30" @click="openModal = false" x-show="openModal"></div>


        {{-- Modal --}}
        <div x-show="openModal" x-cloak class="fixed inset-0 z-50 flex items-center justify-center px-4 py-6 sm:px-0"
                ...
                <form wire:submit.prevent="save" class="px-5 py-4 space-y-4">
                        ...
                        <div class="mt-1">
                            <div class="flex items-center rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm shadow-sm"
                                ...
                                <input type="text" wire:model.live.debounce.300ms="employeeSearch"
                                    ...
                                    class="flex-1 bg-transparent outline-none text-sm" @focus="open = true"
                                    autocomplete="off">
                        ...
                        <div x-show="open" x-cloak @click.away="open = false"
                            ...
                            @forelse ($employeeOptions as $emp)
                                <button type="button"
                                    ...
                                    wire:click="selectEmployee({{ $emp['id'] }})" @click="open = false">
                                    <div>
                    ...
                    <div class="flex items-center justify-between border-t border-slate-100 pt-3">
                        ...
                        <div class="space-x-2">
                            ...
                            <button type="submit"
                                class="inline-flex items-center rounded-lg bg-indigo-600 px-3 py-1.5 text-xs font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-1">
    ...
    <div x-data="{ openPasswordModal: @entangle('showPasswordModal').live }">
        ...
        <div class="fixed inset-0 z-40 bg-black/30" @click="openPasswordModal = false" x-show="openPasswordModal">
        </div>


        {{-- Password Modal --}}
        <div x-show="openPasswordModal" x-cloak
            class="fixed inset-0 z-50 flex items-center justify-center px-4 py-6 sm:px-0" x-transition.opacity>
            ...
            <div class="w-full max-w-md rounded-2xl bg-white shadow-xl ring-1 ring-slate-200" @click.stop>
                ...
                <form wire:submit.prevent="savePassword" class="px-5 py-4 space-y-4">
                    ...
                    <div>
                        ...
                        <input type="password" wire:model.defer="newPassword_confirmation"
                            class="mt-1 w-full rounded-lg border border-slate-200 px-3 py-2 text-sm shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500">
                    </div>
