  ...
  <div class="card border-0 shadow-sm mb-3 overflow-hidden design-hero">
    <div class="card-body p-3 p-md-4">
      ...
      <div class="d-flex flex-wrap gap-2 mt-3">
        ...
        @if($deptSelected)
          <span class="badge rounded-pill bg-primary-subtle text-primary border border-primary-subtle fw-normal">
            <i class="bi bi-pin-angle me-1"></i> Selected: <span class="fw-semibold ms-1">{{ $deptSelected }}</span>
          </span>
        @endif
      </div>
    </div>
  ...
  <div class="card border-0 shadow-sm">
    <div class="card-header bg-white border-0 pb-0">
      <ul class="nav nav-tabs small" role="tablist">
        <li class="nav-item" role="presentation">
          <button class="nav-link @if(!$deptId) active @endif" data-bs-toggle="tab" data-bs-target="#tabOverview"
                  type="button" role="tab" aria-selected="{{ $deptId ? 'false' : 'true' }}">
            <i class="bi bi-table me-1"></i> Overview
          </button>
        </li>
        <li class="nav-item" role="presentation">
          <button class="nav-link @if($deptId) active @endif" data-bs-toggle="tab" data-bs-target="#tabDetail"
                  type="button" role="tab" aria-selected="{{ $deptId ? 'true' : 'false' }}">
    ...
    <div class="card-body pt-3">
      <div class="tab-content">
        {{-- OVERVIEW TAB --}}
        <div class="tab-pane fade @if(!$deptId) show active @endif" id="tabOverview" role="tabpanel">
              ...
              <tbody>
                @forelse($totals as $r)
                  <tr class="row-hoverable">
                    ...
                    <td class="text-end fw-semibold">Rp {{ number_format($r->total_expense, 0, ',', '.') }}</td>
                    <td class="text-end">
        ...
        {{-- DETAIL TAB --}}
        <div class="tab-pane fade @if($deptId) show active @endif" id="tabDetail" role="tabpanel">
          @if(!$deptId)
      ...
      mountChart() {
        ...
        this.chart = new Chart(ctx, {
          ...
          options: {
            ...
            scales: {
              y: { beginAtZero: true, ticks: { callback: (v) => 'Rp ' + fmt.format(v) } },
