<div class="dropdown position-relative" wire:key="notif-menu" x-data="{ open: @entangle("open").live, ready: @js($ready) }"
  ...
  <div x-ref="menu" class="dropdown-menu notif-menu shadow-lg p-0" x-cloak x-show="open"
    x-transition.opacity.scale.origin.top.right :class="{ 'show': open }" role="menu"
    tabindex="-1" @keydown.escape.stop="open = false; $nextTick(() => $refs.trigger.focus())">
    {{-- Header --}}
    ...
    @isset($filter)
      <div class="px-3 pt-2 pb-1">
        <div class="d-flex flex-wrap gap-2">
          <button class="chip {{ $filter === "all" ? "chip-active" : "" }}"
