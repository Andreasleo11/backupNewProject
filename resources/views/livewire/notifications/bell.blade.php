<div class="relative" x-data="{ open: false }">
    ...
    <div
        ...
        x-cloak
        class="absolute right-0 mt-3 w-80 rounded-2xl bg-white/95 backdrop-blur-xl border border-slate-200/60 shadow-2xl shadow-blue-900/10 p-2 z-[60]"
    >
                        ...
                        <button type="button"
                            ...
                            <div class="relative shrink-0 mt-1">
                                <div class="h-2 w-2 rounded-full transition-all duration-300 
                                           {{ $isUnread ? 'bg-blue-500 shadow-[0_0_8px_rgba(99,102,241,0.6)] animate-pulse' : 'bg-slate-300' }}"></div>
                            </div>
                            <div class="flex-1 min-w-0">
                                <div class="text-[11px] font-bold text-slate-800 leading-tight group-hover:text-blue-950">
