                        ...
                        <tr wire:key="veh-{{ $v->id }}">
                            ...
                            <td class="text-end">
                                <div class="btn-group">
                                    ...
                                    <a class="btn btn-sm btn-outline-primary" href="{{ route('vehicles.edit', $v) }}"
                                        title="Edit Vehicle"><i class="bi bi-pencil"></i>
                                    </a>
        ...
        @forelse($vehicles as $v)
            ...
            <div class="card border-0 shadow-sm mb-2">
                ...
                <div class="card-footer d-flex gap-2" wire:loading.class="opacity-50"
                    ...
                    <a class="btn btn-sm btn-outline-secondary flex-fill" href="{{ route('vehicles.show', $v) }}"><i
                            class="bi bi-eye me-1"></i>Detail</a>
                    <a class="btn btn-sm btn-outline-primary flex-fill" href="{{ route('vehicles.edit', $v) }}"><i
