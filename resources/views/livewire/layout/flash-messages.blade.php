<div>
    @if ($message)
        ...
        <div x-data="{ show: true }" x-init="@if ($type === 'success') setTimeout(() => show = false, 5000) @endif" x-show="show"
            ...
            <div class="flex items-center justify-between gap-4">
                <div class="flex items-center gap-3.5">
                    <div
                        class="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl {{ $config['icon_bg'] }} {{ $config['icon_color'] }} shadow-sm">
                    ...
                    <div>
                        ...
                        @if ($type === 'success')
                            <p class="text-[10px] font-medium text-emerald-600/70 mt-0.5">Auto-dismissing in 5 seconds
                            </p>
                        @endif
                    </div>
                </div>
                ...
                <button type="button"
                    ...
                    @click="show = false" wire:click="clear">
