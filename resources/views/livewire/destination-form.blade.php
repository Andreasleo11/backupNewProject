                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input wire:model.defer="name" type="text"
                            class="form-control @error('name') is-invalid @enderror" placeholder="e.g. Surabaya Port">
                        @error('name')
                    ...
                    <div class="col-md-6">
                        ...
                        <input wire:model.defer="city" type="text" class="form-control" placeholder="e.g. Surabaya">
                    </div>
                </div>
