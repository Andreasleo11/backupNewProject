<div>
  ...
  <div class="card shadow-sm mb-4">
    <div class="card-body p-0">
      @forelse ($details as $index => $detail)
        <div class="row g-3 align-items-start px-3 py-2 border-bottom"
          wire:key="detail-row-{{ $index }}">
          {{-- Part Name --}}
          <div class="col-md">
          ...
          <div class="col">
            ...
            <div class="input-group" x-data="{
              ...
              <input type="text"
                class="form-control @error("details.$index.price") is-invalid @enderror"
                x-model="input" x-on:input="input = formatNumber(unformat($event.target.value))"
                placeholder="Price">
            </div>
  ...
  <div class="d-flex justify-content-between">
    <button class="btn btn-secondary" wire:click="goBack"><i class="bi bi-arrow-left"></i>
      Back</button>
    <button class="btn btn-primary" wire:click="saveDetails">Next <i
