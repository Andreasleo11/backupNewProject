        ...
        <div class="card-body py-3">
            <div class="row g-2 align-items-center">
                ...
                <div class="col-6 col-lg-1 d-flex gap-2">
                    <button class="btn btn-outline-secondary btn-sm w-100" wire:click="toggleDir"
                        title="Toggle sort direction">
                        <i class="bi {{ $dir === 'asc' ? 'bi-arrow-down-up' : 'bi-arrow-up-down' }}"></i>
                    </button>
                    <select class="form-select form-select-sm" wire:model.live="perPage" title="Per page"
            ...
            <thead class="table-light">
                <tr>
                    ...
                    <th role="button" wire:click="sortBy('name')">
                        Department {!! $this->sortIcon('name') !!}
                    </th>
                    <th style="width:320px" role="button" wire:click="sortBy('percent')">
                        Compliance {!! $this->sortIcon('percent') !!}
                    </th>
                    <th>Status</th>
