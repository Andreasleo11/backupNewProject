  ...
  <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-3">
    ...
    <div class="d-flex flex-wrap align-items-center gap-2">
      <div class="input-group input-group-sm" style="width: 260px;">
        ...
        <input class="form-control" type="search" placeholder="Search item/source/uom…" wire:model.live.debounce.300ms="search">
      </div>
  ...
  <div class="detail-table-wrapper">
    <table class="table table-striped table-hover align-middle mb-0 table-sticky">
      <thead class="table-light">
        <tr>
          @php
            $arrow = fn($col) => $sortBy === $col ? ($sortDir === 'asc' ? 'bi-caret-up-fill' : 'bi-caret-down-fill') : 'bi-filter';
          @endphp
...
@pushOnce('extraCss')
<style>
  .detail-table-wrapper { max-height: 56vh; overflow: auto; border-radius: .5rem; }
  .table-sticky thead th { position: sticky; top: 0; z-index: 1; background: #fff; box-shadow: 0 1px 0 rgba(0,0,0,.05); }
  .num { font-variant-numeric: tabular-nums; }
  .cell-clip { max-width: 520px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
