<div class="row">
    ...
    <div class="mb-4">
        ...
        <p class="text-muted">You need to add part defects for each of part details that you have been added before.</p>
    </div>
            ...
            <div class="card bg-light border-1 mb-4">
                <div class="card-header fw-semibold bg-white d-flex justify-content-between">
                    ...
                    <button type="button" data-bs-toggle="modal"
                        data-bs-target="#add-defect-category-modal-1" class="btn btn-outline-primary btn-sm">+ Add Category</button>
                </div>
                <div class="card-body">
                    {{-- Defect Source --}}
                    <div class="mb-3">
    ...
    <div class="d-flex justify-content-between mt-4">
        ...
        <button class="btn btn-primary" wire:click="nextStep">Next <i class="bi bi-arrow-right"></i></button>
    </div>
