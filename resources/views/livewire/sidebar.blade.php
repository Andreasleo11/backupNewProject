{{-- 
    ⚠️ DEPRECATED: This sidebar component is deprecated as of 2026-01-28
    
    Please migrate to the new Alpine.js sidebar system:
    - New Layout: @extends('new.layouts.app')
    - Navigation: App\Services\NavigationService
    
    See .deprecation/SIDEBAR_DEPRECATION_PLAN.md for migration guide
--}}
