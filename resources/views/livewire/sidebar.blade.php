<aside id="sidebar" role="navigation" aria-label="Sidebar">
  <div class="sidebar-head d-flex align-items-center gap-2 px-2">
    ...
    <button class="btn-icon btn-sidebar-toggle" type="button" aria-controls="sidebar"
    ...
    <div class="sidebar-controls ms-auto d-none d-sm-flex">
      <button class="btn btn-icon btn-ghost-light me-1" id="btnExpandAll" type="button"
        data-bs-toggle="tooltip" data-bs-placement="bottom" title="Expand all groups">
        <i class="bx bx-expand-vertical"></i>
      </button>
      <button class="btn btn-icon btn-ghost-light" id="btnCollapseAll" type="button"
        data-bs-toggle="tooltip" data-bs-placement="bottom" title="Collapse all groups">
  ...
  <ul class="sidebar-nav" id="sidebarNavRoot">
    ...
    @if ($isSuper)
      <x-sidebar.group id="adminGroup" icon="bx bx-bug" title="Admin" :open="$groupOpen['adminGroup'] ?? false">
        <li class="sidebar-item">
          <x-sidebar.link :href="route('superadmin.users')" icon="bx bx-user"
            :active="request()->routeIs('superadmin.users*')">Users</x-sidebar.link>
        </li>
        <li class="sidebar-item">
    ...
    @if (in_array($department, ['QA', 'QC', 'BUSINESS']) || $isSuper || $user->name === 'herlina')
      <x-sidebar.group id="qualityGroup" icon="bx bx-badge-check" title="Quality"
        :open="$groupOpen['qualityGroup'] ?? false">
        <li class="sidebar-item">
    ...
    @if (in_array($department, ['PRODUCTION', 'PE', 'PPIC']) || $isSuper)
      <x-sidebar.group id="productionGroup" icon="bx bxs-factory" title="Production"
        :open="$groupOpen['productionGroup'] ?? false">
        <li class="sidebar-item">
    ...
    @if ($department === 'MAINTENANCE' || $isSuper || $department === 'PPIC')
      <x-sidebar.group id="maintenanceGroup" icon="bx bxs-wrench" title="Maintenance"
        :open="$groupOpen['maintenanceGroup'] ?? false">
        <li class="sidebar-item">
    ...
    @if (($department === 'PERSONALIA' && $deptHead) || $isSuper)
      <x-sidebar.group id="humanResourceGroup" icon="bx bxs-user" title="Human Resource"
        :open="$groupOpen['humanResourceGroup'] ?? false">
        <li class="sidebar-item">
    ...
    @if ($department === 'PURCHASING' || $isSuper)
      <x-sidebar.group id="purchasingGroup" icon="bx bx-dollar-circle" title="Purchasing"
        :open="$groupOpen['purchasingGroup'] ?? false">
        <li class="sidebar-item">
        ...
        <li class="sidebar-item">
          <x-sidebar.link :href="route('reminderindex')" icon="bx bx-file"
            :active="request()->routeIs('reminderindex')">Reminder</x-sidebar.link>
        </li>
        <li class="sidebar-item">
    ...
    @if ($department === 'ACCOUNTING' || $isSuper)
      <x-sidebar.group id="accountingGroup" icon="bx bx-dollar" title="Accounting"
        :open="$groupOpen['accountingGroup'] ?? false">
        <li class="sidebar-item">
    ...
    {{-- Inventory --}}
    <x-sidebar.group id="inventoryGroup" icon="bx bxs-component" title="Inventory"
      :open="$groupOpen['inventoryGroup'] ?? false">
      <li class="sidebar-item">
    ...
    <x-sidebar.group id="storeGroup" icon="bx bxs-component" title="Store" :open="$groupOpen['storeGroup'] ?? false">
      ...
      <li class="sidebar-item">
        <x-sidebar.link :href="route('destination.index')" icon="bx bx-file"
          :active="request()->routeIs('destination.*')">Destination</x-sidebar.link>
      </li>
      <li class="sidebar-item">
        <x-sidebar.link :href="route('vehicles.index')" icon="bx bx-file"
          :active="request()->routeIs('vehicles.*')">Vehicles</x-sidebar.link>
      </li>
    </x-sidebar.group>
    ...
    {{-- Monthly Budget --}}
    <x-sidebar.group id="monthlyBudgetGroup" icon="bx bx-file" title="Monthly Budget"
      :open="$groupOpen['monthlyBudgetGroup'] ?? false">
      <li class="sidebar-item">
        <x-sidebar.link :href="route('monthly.budget.report.index')" icon="bx bx-file"
          :active="request()->routeIs('monthly.budget.report.*')">Reports</x-sidebar.link>
      </li>
      <li class="sidebar-item">
    ...
    <x-sidebar.group id="employeeEvaluationGroup" icon="bx bx-file" title="Employee Evaluation"
      ...
      <li class="sidebar-item">
        <x-sidebar.link :href="route('discipline.index')" icon="bx bx-file"
          :active="request()->routeIs('discipline.*')">All</x-sidebar.link>
      </li>
      <li class="sidebar-item">
        <x-sidebar.link :href="route('yayasan.table')" icon="bx bx-file"
          :active="request()->routeIs('yayasan.table')">Yayasan</x-sidebar.link>
      </li>
      <li class="sidebar-item">
        <x-sidebar.link :href="route('magang.table')" icon="bx bx-file"
          :active="request()->routeIs('magang.table')">Magang</x-sidebar.link>
      </li>
      <li class="sidebar-item">
    ...
    {{-- Other --}}
    <x-sidebar.group id="otherGroup" icon="bx bx-dots-horizontal-rounded" title="Other"
      :open="$groupOpen['otherGroup'] ?? false">
      <li class="sidebar-item">
        <x-sidebar.link :href="$specification === 'DIRECTOR' ? route('director.pr.index') : route('purchaserequest.home')" icon="bx bx-file" :active="request()->routeIs('director.pr.index') ||
            request()->routeIs('purchaserequest.home')">
          Purchase Request
        </x-sidebar.link>
      </li>
      <li class="sidebar-item">
      ...
      <li class="sidebar-item">
        <x-sidebar.link :href="route('spk.index')" icon="bx bx-file"
          :active="request()->routeIs('spk.*')">SPK</x-sidebar.link>
      </li>
      <li class="sidebar-item">
      ...
      <li class="sidebar-item">
        <x-sidebar.link :href="route('files.index')" icon="bx bx-file"
          :active="request()->routeIs('files.*')">Files</x-sidebar.link>
      </li>
      <li class="sidebar-item">
  ...
  <div id="sidebar-flyout" class="sidebar-flyout" role="dialog" aria-modal="false"
    aria-hidden="true">
