        ...
        <div class="card-body">
            ...
            <div class="mb-3">
                ...
                <input type="text" id="inspection_report_document_number"
                    wire:model.blur="inspection_report_document_number" class="form-control bg-secondary-subtle"
                    readonly>
        ...
        <div class="card-body">
            <div class="row g-2 align-items-end">
                ...
                <div class="col">
                    ...
                    <input type="text" class="form-control bg-secondary-subtle" wire:model="reject_rate" readonly>
                </div>
            </div>
