<div data-step-sampling>
  ...
  <div wire:ignore
      ...
      x-init="
        const root = $el.closest('[data-step-sampling]');
    ...
    <div class="card p-3 mb-3 border">
      <div class="row g-3">
        ...
        <div class="col">
          ...
          <input type="number" wire:model.blur="samples.{{ $index }}.quantity"
            @class([
              ...
              'is-valid' => $rk && $this->isRowFieldSaved($rk, 'quantity') && !$errors->has("samples.$index.quantity"),
            ])>
        ...
        <div class="col">
          ...
          <input type="text"
            ...
            @class([
              ...
              'is-valid' => $rk && $this->isRowFieldSaved($rk, 'box_label') && !$errors->has("samples.$index.box_label"),
            ])>
        ...
        <div class="col">
          ...
          <select wire:model.live="samples.{{ $index }}.appearance"
            @class([
              'form-select',
              'is-invalid' => $errors->has("samples.$index.appearance"),
              'is-valid' => $rk && $this->isRowFieldSaved($rk, 'appearance') && !$errors->has("samples.$index.appearance"),
            ])>
        ...
        @if (($sample['appearance'] ?? '') === 'NG')
          <div class="col">
            ...
            <input type="number"
              ...
              'is-valid' => $rk && $this->isRowFieldSaved($rk, 'ng_quantity') && !$errors->has("samples.$index.ng_quantity"),
            ])>
          ...
          <div class="col">
            ...
            <input type="text"
              ...
              @class([
                ...
                'is-valid' => $rk && $this->isRowFieldSaved($rk, 'remarks') && !$errors->has("samples.$index.remarks"),
              ])>
