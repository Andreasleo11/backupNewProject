    ...
    <div class="card p-3 mb-3 border">
      <div class="row g-3">
        ...
        <div class="col">
          ...
          <input type="number"
            class="form-control @error("samples.$index.quantity") is-invalid @enderror"
        ...
        <div class="col">
          ...
          <input type="text"
            class="form-control @error("samples.$index.box_label") is-invalid @enderror"
        ...
        @if (($sample['appearance'] ?? '') === 'NG')
          ...
          <div class="col">
            ...
            <input type="text"
              class="form-control @error("samples.$index.remarks") is-invalid @enderror"
