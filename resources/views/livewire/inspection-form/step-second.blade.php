  ...
  <div class="card mb-4">
    <div class="card-body">
      ...
      <div wire:ignore
          ...
          x-init="
            const root = $el.parentElement.querySelector('[data-step-second]'); // sibling lookup
      ...
      <div data-step-second>
        <div class="@if (!$showDocumentInfo) d-none @endif">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control bg-secondary-subtle"
              wire:model.blur="document_number" readonly>
      ...
      @if ($secondInspectionSaved)
        <div>
          <div class="fw-bold text-primary mb-2 @if($savedSamples) text-success @endif">Sampling</div>
          @livewire('inspection-form.step-sampling', ['second_inspection_document_number' => $document_number], key('step-sampling'))

          <div class="mt-4">
            <div class="fw-bold text-primary mb-2 @if($savedPackagings) text-success @endif">Packaging</div>
