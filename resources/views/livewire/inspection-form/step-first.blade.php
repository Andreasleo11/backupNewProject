<div data-step-first>
  ...
  <div wire:ignore 
    ...
    x-init="
      const root = $el.closest('[data-step-first]');
      ...
      <div class="row">
          ...
          <div class="row">
            <div class="col">
              ...
              <div class="input-group">
                ...
                <select class="form-select @error('weight_uom') is-invalid @enderror @if($this->hasBaseline && $this->isGroupSaved(['weight', 'weight_uom']) && !$errors->has('weight_uom')) is-valid @endif"
        ...
        <div class="col">
          ...
          <input type="text" id="fitting_test" wire:model.blur="fitting_test"
            class="form-control @error('fitting_test') is-invalid @enderror @if($this->hasBaseline && $this->isFieldSaved('fitting_test') && !$errors->has('fitting_test')) is-valid @endif" placeholder="Optional">
          @error('fitting_test')
            <span class="invalid-feedback">{{ $message }}</span>
          @enderror
        </div>
  ...
  <div class="text-end">
    <button type="button" class="btn btn-outline-primary" wire:click="saveStep"
            ...
            x-data="{ justSaved:false }"
            x-init="Livewire.on('firstInspectionSaved', () => { justSaved = true; setTimeout(()=>justSaved=false, 1500) })">
