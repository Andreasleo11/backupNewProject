<div>
    ...
    <div class="card mb-4 @if (!$showDocumentInfo) d-none @endif">
        <div class="card-body">
            ...
            <div class="mb-3">
                <label for="detail_inspection_report_document_number" class="form-label">Detail Inspection Report Document
    ...
    <div class="text-end">
        <button type="button" class="btn btn-outline-primary" wire:click="saveStep">Save First Inspection</button>
