<div data-step-packaging>
  ...
  <div wire:ignore
      ...
      x-init="
        const root = $el.closest('[data-step-packaging]');
      ...
      <div class="row g-3">
        <div class="col @if (!$showDocumentInfo) d-none @endif">
          ...
          <input type="text"
            ...
            wire:model.blur="packagings.{{ $index }}.second_inspection_document_number"
            readonly>
        ...
        <div class="col">
          ...
          @class([
              ...
              'is-valid' => $rk && $this->isRowFieldSaved($rk, 'snp') && !$errors->has("packagings.$index.snp"),
            ])>
        ...
        <div class="col">
          ...
          <input type="text"
            ...
            @class([
              ...
              'is-valid' => $rk && $this->isRowFieldSaved($rk, 'box_label') && !$errors->has("packagings.$index.box_label"),
            ])>
        ...
        <div class="col">
          ...
          <select wire:model.live="packagings.{{ $index }}.judgement"
          @class([
              'form-select',
              'is-invalid' => $errors->has("packagings.$index.judgement"),
              'is-valid' => $rk && $this->isRowFieldSaved($rk, 'judgement') && !$errors->has("packagings.$index.judgement"),
            ])>
        ...
        @if (($item['judgement'] ?? '') === 'NG')
          <div class="col">
            ...
            @class([
              ...
              'is-valid' => $rk && $this->isRowFieldSaved($rk, 'remarks') && !$errors->has("packagings.$index.remarks"),
            ])></input>
