            ...
            <div class="flex">
                ...
                <div class="ml-3">
                    <h3 class="text-sm font-medium text-yellow-800">
                        Purchase Order Not Editable
                    </h3>
                    <div class="mt-2 text-sm text-yellow-700">
                        <p>This purchase order has status <strong>{{ $purchaseOrder->getStatusEnum()->label() }}</strong> and cannot be edited.</p>
                    </div>
                </div>
            </div>
        </div>
    @else
        <form wire:submit="save" class="p-8 space-y-6">
            ...
            <div class="flex items-center justify-end gap-3 pt-4 border-t border-slate-100">
                <button wire:click="$dispatch('exitFormMode')"
                        type="button"
