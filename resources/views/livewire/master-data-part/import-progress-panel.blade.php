...
<div id="progress-panel" @if ($this->job?->status === 'running') wire:poll.1500ms="refreshProgress" @endif
    ...
    @if ($jobId && $this->job)
        ...
        <div class="progress" style="height: 26px;">
            <div class="progress-bar {{ $this->job->status === 'completed' ? 'bg-success' : '' }}
        ...
        @if ($this->job?->status === 'running' && $this->heartbeatAgeSeconds !== null && $this->heartbeatAgeSeconds >= 120)
            <div class="alert alert-warning mt-3">
                ...
                <button type="button" class="btn btn-sm btn-outline-danger mt-2" wire:click="forceFailIfStalled">
                    Mark as Failed
                </button>
            </div>
        @endif
