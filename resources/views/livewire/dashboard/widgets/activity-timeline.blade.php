<div class="h-full flex flex-col rounded-3xl bg-white border border-slate-200 shadow-sm overflow-hidden group hover:shadow-xl hover:border-violet-100 transition-all duration-500">
            ...
            <div class="space-y-8">
                @forelse ($activities as $activity)
                    ...
                    <div class="relative pl-10 group/activity">
                        {{-- Icon Dot --}}
                        <div class="absolute left-0 top-0.5 h-8 w-8 rounded-full {{ $color }} border-4 border-white shadow-sm flex items-center justify-center z-10 transition-transform group-hover/activity:scale-110">
                        ...
                        <div class="flex flex-col">
                            <p class="text-[13px] text-slate-600 leading-relaxed pt-0.5">
                                ...
                                <span class="font-bold text-slate-800">{{ $activity->subject?->doc_number ?? $activity->subject?->name ?? '' }}</span>
                            </p>
                            <span class="text-[10px] font-medium text-slate-400 mt-1 flex items-center gap-1.5 uppercase tracking-wider">
    ...
    <div class="px-6 py-4 bg-slate-50/50 border-t border-slate-100 mt-auto">
        <a href="#" class="text-[11px] font-black uppercase tracking-widest text-violet-600 hover:text-violet-800 transition-colors flex items-center gap-2 group/all">
            Full Audit Log
