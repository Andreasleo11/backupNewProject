<div class="space-y-8 pb-12">
        ...
        <div class="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div>
                ...
                <h1 class="text-3xl font-extrabold text-slate-900 tracking-tight">
                    {{ $greeting }}, <span
                        class="bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-violet-600">{{ auth()->user()->name }}</span>!
                </h1>
                <p class="mt-2 text-slate-500 font-medium max-w-lg">
                    Welcome back to the system. You have <span
                        class="text-blue-600 font-bold underline decoration-blue-200 underline-offset-4">{{ $kpis['pending_approvals'] }}</span>
                    pending tasks in your inbox.
                </p>
            </div>
    ...
    <div class="grid grid-cols-12 gap-6">
        ...
        <div class="col-span-12 lg:col-span-4 space-y-6">
            <div
                class="h-full rounded-3xl bg-white border border-slate-200 shadow-sm p-6 overflow-hidden relative group hover:border-indigo-100 transition-all">
                <div
                    class="absolute -right-10 -top-10 h-32 w-32 rounded-full bg-indigo-50 blur-3xl group-hover:bg-indigo-100 transition-colors duration-700">
                </div>
                <div class="relative z-10 flex flex-col h-full">
                    ...
                    <div class="space-y-4 flex-1">
                        <a href="{{ route('purchase-requests.create') }}"
                            ...
                            <div class="flex text-left items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-[10px] text-indigo-100 uppercase tracking-widest font-bold mt-0.5">
                                        Request Items</p>
                                </div>
                            </div>
                            <i
                        ...
                        <a href="{{ route('overtime.create') }}"
                            ...
                            <div class="flex text-left items-center gap-4">
                                <div
                                    class="h-10 w-10 bg-amber-100 text-amber-600 rounded-xl flex items-center justify-center">
