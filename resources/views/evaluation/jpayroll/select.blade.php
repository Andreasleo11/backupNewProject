...
<div class="max-w-lg bg-white rounded-2xl shadow-sm premium-shadow border border-slate-100 overflow-hidden">
    ...
    <div class="bg-gradient-to-r from-indigo-600 to-violet-600 px-6 py-5">
        ...
        <p class="text-xs text-white/70 mt-1">
            Data yang sudah <strong class="text-white">dept_approved</strong> akan diproses dan dikategorisasi ke nilai A atau B.
        </p>
    </div>
    ...
    <form action="{{ route('evaluation.jpayroll.index') }}" method="GET" class="px-6 py-6 space-y-5">
        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            <div>
                ...
                <select name="month" class="form-select rounded-xl border-slate-200 text-sm w-full focus:ring-indigo-400 focus:border-indigo-400">
            ...
            <div>
                ...
                <select name="year" class="form-select rounded-xl border-slate-200 text-sm w-full focus:ring-indigo-400 focus:border-indigo-400">
