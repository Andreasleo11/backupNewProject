...
@section('content')
    {{-- Wrapper dengan Alpine untuk handle modal --}}
    <div x-data="{ openAddModal: false }" class="max-w-7xl mx-auto px-4 py-6">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-3 mb-5">
            <div>
                ...
                <p class="mt-1 text-sm text-slate-500">
                    Index untuk MouldDown – pantau dan tambahkan data mould yang sedang down.
                </p>
            </div>
            ...
            <div class="bg-white border border-slate-200 rounded-xl shadow-sm">
                <div class="p-3 md:p-4">
                    <div class="overflow-x-auto">
                        {{-- Biarkan DataTables generate tabelnya --}}
                        {{ $dataTable->table() }}
                    </div>
                </div>
            </div>
        ...
        {{-- === MODAL ADD NEW MOULD (Tailwind + Alpine) === --}}
        <div x-show="openAddModal" x-cloak class="fixed inset-0 z-50 flex items-center justify-center bg-black/40"
            ...
            <div
                ...
                <form method="POST" action="{{ route('addmould') }}" class="flex flex-col">
                    @csrf
                    ...
                    <div class="px-5 pt-5 pb-3 flex items-start justify-between gap-3 border-b border-slate-100">
                        <div>
                            ...
                            <p class="mt-1 text-xs text-slate-500">
                                Masukkan informasi mould yang sedang down dan estimasi selesai.
                            </p>
                        </div>
                    ...
                    <div class="px-5 pt-4 pb-2 space-y-4">
                        {{-- Mould Code --}}
                        <div>
                            <label for="mould_code" class="block text-xs font-medium text-slate-700 mb-1.5">
                                Mould Code
                            </label>
                            <input type="text" name="mould_code" id="mould_code"
    ...
    {{-- DataTables script tetap di-load --}}
    {{ $dataTable->scripts() }}
@endsection
