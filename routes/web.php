...
// FORM LAPOR
    Route::get('/form-lapor', [LaporController::class, 'index'])->name('formlapor.home');
    Route::get('/form-lapor/create', [LaporController::class, 'create'])->name('formlapor.create');
    Route::post('/form-lapor/insert', [LaporController::class, 'store'])->name('formlapor.insert');
    Route::get('/form-lapor/detail/{id}', [LaporController::class, 'detail'])->name('formlapor.detail');
