...
test('handle creates pr generates number and dispatches event', function () {
    ...
    $mockPr->to_department = \App\Enums\ToDepartment::MAINTENANCE;
    $mockPr->branch = 'JAKARTA';
    $mockPr->type = 'office';
    $mockPr->items = new \Illuminate\Database\Eloquent\Collection([]);
