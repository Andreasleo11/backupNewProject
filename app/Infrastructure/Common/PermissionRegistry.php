    ...
    public static function getModules(): array
    {
        return [
            ...
            'Purchase Request' => [
                ...
                'roles' => [
                    'requester' => ['pr.view', 'pr.create', 'pr.edit', 'pr.delete', 'pr.cancel', 'pr.upload-files', 'pr.print'],
                    'pr-dept-head' => ['pr.view', 'pr.view-all', 'pr.create', 'pr.edit', 'pr.cancel', 'pr.upload-files', 'pr.print', 'approval.approve', 'approval.reject', 'approval.approve-items'],
                    'pr-verificator' => ['pr.view', 'pr.view-all', 'pr.print', 'approval.approve', 'approval.reject', 'approval.approve-items'],
                    'pr-gm' => ['pr.view', 'pr.view-all', 'pr.print', 'approval.approve', 'approval.reject', 'approval.approve-items'],
                    'pr-director' => ['pr.view', 'pr.view-all', 'pr.print', 'approval.approve', 'approval.reject', 'approval.approve-items', 'pr.batch-approve'],
                    'pr-purchaser' => ['pr.view', 'pr.view-all', 'pr.create', 'pr.edit', 'pr.cancel', 'pr.upload-files', 'pr.print', 'approval.approve'],
                    'pr-admin' => ['pr.view-all', 'pr.batch-approve', 'approval.manage-rules', 'approval.view-log'],
                ],
            ],
            'Approval Engine' => [
                'permissions' => [
