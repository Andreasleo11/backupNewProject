...
class ApiHelper
{
    ...
    public static function validateParams(array $params, array $required)
    {
        ...
        if (!empty($missing)) {
            return self::response(false, 'Missing required parameter(s): ' . implode(', ', $missing), null);
        }
    ...
    public static function handleApiResponse(array $apiResult)
    {
        ...
        return self::response(true, 'Data retrieved successfully.', $apiResult['data'], $apiResult['total']);
    }
}
