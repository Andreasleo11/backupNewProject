...
class UpdateSuratPerintahKerjaRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            "keterangan_laporan.max" =>
                "Keterangan Laporan may not be greater than 1000 characters.",
            ...
            "for.in" =>
                'The selected option for "For" is invalid. Please choose either "mould" or "machine".',
        ];
    }
}
