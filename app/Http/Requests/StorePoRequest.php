...
class StorePoRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'invoice_date.required' => 'The PO date is required.',
            'tanggal_pembayaran.required' => 'The Invoice Date is required.',
            'tanggal_pembayaran.date' => 'The Invoice Date must be a valid date.',
