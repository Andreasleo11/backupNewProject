...
class MonthlyBudgetReportDetailController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()
            ->back()
            ->with('success', 'Monthly Budget Report Detail created successfully1');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()
            ->back()
            ->with('success', 'Monthly Budget Report Detail updated successfully!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()
            ->back()
            ->with('success', 'Monthly Budget Report Detail deleted successfully!');
    }
}
