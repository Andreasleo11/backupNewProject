...
class EmployeeTrainingController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('employee_trainings.index')->with('success', 'Training record added successfully.');
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('employee_trainings.index')->with('success', 'Training record updated successfully.');
    }
