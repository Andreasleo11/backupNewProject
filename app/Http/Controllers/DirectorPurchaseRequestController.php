...
class DirectorPurchaseRequestController extends Controller
{
        ...
        if (empty($ids)) {
            ...
            try {
                ...
                return response()->json([
                    "message" => "selected records approved successfully. (server)",
                ]);
            } catch (\Throwable $th) {
                return response()->json([
                    "message" => "failed to approve selected records. (server)",
                ]);
                throw $th;
            }
        }
    ...
    public function rejectSelected(Request $request)
    {
        ...
        try {
            ...
            return response()->json([
                "message" => "selected records rejected successfully. (server)",
            ]);
        } catch (\Throwable $th) {
