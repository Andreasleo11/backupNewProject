...
class NewBusController extends Controller
{
	...
	public function delivery_schedule()
    {
        ...
        return view('program/new_business/delivery_schedule/bus_del_delsched', ['delivery_schedule' => $tab_delivery_schedule, 'last_update' => $val_last_update]);
    }
	...
	public function delivery_schedule_proses_1()
    {
		...
		foreach($tab_sap_delsched as $sap_delsched){
			...
			$tab_sap_customer = DB::table('sap_fg_customer')->where('item_code',$val_item_code_i)->first();	
	...
	public function delivery_schedule_wip()
    {
        ...
        return view('program/new_business/delivery_schedule/bus_del_delsched_wip', ['delivery_schedule' => $tab_delivery_schedule, 'last_update' => $val_last_update]);
    }
