...
class QaqcReportController extends Controller
{
    ...
    public function index(Request $request, VqcReportsDataTable $dataTable)
    {
        ...
        return $dataTable
            ->with("status", $status)
            ->render("qaqc.reports.index", compact("reports", "status"));
    }
    ...
    public function redirectToIndex()
    {
        ...
        return redirect()
            ->route("qaqc.report.index")
            ->with(["success" => "Report succesfully stored/updated!"]);
    }
    ...
    public function savePdf($id)
    {
        ...
        return redirect()
            ->back()
            ->with(["message" => "PDF saved successfully", "file_path" => $filePath]);
    }
    ...
    public function sendEmail($id, Request $request)
    {
        ...
        $mailData = [
            "to" =>
                ...
                "raymondlay023@gmail.com",
            "cc" => array_filter(array_map("trim", explode(";", $request->cc))) ?? [
                "andreasleonardo.al@gmail.com",
    ...
    public function rejectAuto(Request $request, $id)
    {
        ...
        return redirect()
            ->back()
            ->with(["success" => "Report rejected automatically!"]);
    }
    ...
    public function lock($id)
    {
        ...
        return redirect()
            ->back()
            ->with(["success" => "Report locked successfully!"]);
    }
        ...
        foreach ($groupedByMonth as $month => $reports) {
            ...
            foreach ($reports as $report) {
                foreach ($report->details as $detail) {
                    ...
                    $result[$month][$customerId]["total_price"] +=
                        $detail->verify_quantity * $detail->price;
                }
            }
        }
