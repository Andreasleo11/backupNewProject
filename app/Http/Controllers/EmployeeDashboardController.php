...
class EmployeeDashboardController extends Controller
{
    ...
    public function getEmployeesByDepartment(Request $request)
    {
        ...
        $query = Employee::whereNull('end_date')->join('departments', 'employees.Dept', '=', 'departments.dept_no')
            ->where('departments.name', $department)
            ->select('employees.NIK', 'employees.Nama', 'employees.Branch', 'employees.employee_status');
    ...
    private function getEmployeeCountByDepartment()
    {
        ...
        $statuses = Employee::whereNull('end_date')->distinct()->pluck('employee_status')->toArray();
    ...
    public function getEmployeeCountByMonth($year = null)
    {
        ...
        try {
            $employeeCounts = Employee::whereNull('end_date')->join('evaluation_datas', 'employees.NIK', '=', 'evaluation_datas.NIK')
