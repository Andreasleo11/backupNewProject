...
class ProdplanKriDelschedDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', 'prodplankridelsched.action')
            ->setRowId('id');
    }
     ...
     *
     * @param \App\Models\ProdplanKriDelsched $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(ProdplanKriDelsched $model): QueryBuilder
    {
    ...
    {
        return $this->builder()
                    ->setTableId('prodplankridelsched-table')
    ...
    {
        return 'ProdplanKriDelsched_' . date('YmdHis');
    }
}
