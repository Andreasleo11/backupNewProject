...
class StepSampling extends Component
{
    ...
    protected $rules = [
        ...
        'samples.*.ng_quantity' => 'required_if:samples.*.appearance,NG|nullable|integer|min:1|lt:samples.*.quantity',
    ...
    protected $messages = [
        ...
        'samples.*.ng_quantity.lte' => 'The NG quantity must be less than or equal to the quantity.',
