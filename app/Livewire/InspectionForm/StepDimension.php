...
class StepDimension extends Component
{
    ...
    protected function rules(): array
    {
        ...
        foreach ($this->dimensions as $i => $row) {
            ...
            $rules["dimensions.$i.upper_limit"] = ['required', 'numeric', "gt:dimensions.$i.lower_limit"];
    ...
    public function saveStep()
    {
        ...
        foreach ($this->dimensions as $index => $dimensions) {
            $this->dimensions[$index]['start_datetime'] = Carbon::parse($this->start_time)->format('Y-m-d H:i:s');
            $this->dimensions[$index]['end_datetime'] = Carbon::parse($this->end_time)->format('Y-m-d H:i:s');
        }
