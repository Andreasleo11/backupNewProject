            ...
            [
                ...
                'children' => [
                    ...
                    [
                        ...
                        'active' => request()->routeIs('admin.users.*') || request()->routeIs('admin.roles.*') || request()->routeIs('admin.permission-sync.*') || request()->routeIs('admin.approval-rules.*') || request()->routeIs('admin.departments.*') || request()->routeIs('admin.employees.*'),
            ...
            [
                ...
                'children' => [
                    ...
                    [
                        ...
                        'icon' => 'chart-bar',
                        'active' => request()->routeIs('assets.dashboard'),
                        'permission' => 'inventory.view',
                    ],
                    [
                        'label' => 'Assets',
                        'route' => 'assets.manage',
                        'icon' => 'cube',
                        'active' => request()->routeIs('assets.manage'),
                        'permission' => 'inventory.view',
                    ],
                    [
                        'label' => 'Consumables',
                        'route' => 'consumables.manage',
                        'icon' => 'archive-box',
                        'active' => request()->routeIs('consumables.manage'),
                        'permission' => 'inventory.view',
                    ],
                    [
                        'label' => 'Locations',
                        ...
                        'icon' => 'map-pin',
                        'active' => request()->routeIs('locations.manage'),
                        'permission' => 'inventory.view',
                    ],
                    [
                        ...
                        'icon' => 'tag',
                        'active' => request()->routeIs('assets.categories'),
                        'permission' => 'inventory.view',
                    ],
                    [
                        'label' => 'Consumable Categories',
                        'route' => 'consumables.categories',
                        'icon' => 'tag',
                        'active' => request()->routeIs('consumables.categories'),
                        'permission' => 'inventory.view',
                    ],
                ],
            ],
