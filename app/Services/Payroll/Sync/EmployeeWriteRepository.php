...
/**
 * Write-side adapter for the employees table used exclusively
 * by the payroll sync pipeline.
 *
 * Read-side queries (paginate, search, stats) belong to
 * App\Domain\Employee\Repositories\EmployeeRepository / EloquentEmployeeRepository.
 */
final class EmployeeWriteRepository
{
    /**
     * Upsert employees by NIK.
     *
    ...
    /**
     * Get all employees indexed by NIK for diff/preview comparison.
     *
    ...
    /**
     * Bulk-update annual leave balances for a map of NIK → remaining days.
     *
