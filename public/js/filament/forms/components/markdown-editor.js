...
`
    ...
    function of(e, t, n, r) {
      ...
      if (s && h < 9 && !l && (!m || (!m.left && !m.right))) {
        ...
        J
          ? (m = { left: J.left, right: J.left + Jr(e.display), top: J.top, bottom: J.bottom })
          : (m = Pa);
      }
      for (
      ...
      var u = De(
          function (P) {
            var J = i[P],
              Y = J.level != 1;
            return vo(
              Xt(e, ne(n, Y ? J.to : J.from, Y ? "before" : "after"), "line", t, r),
              a,
              l,
              !0,
            );
      ...
      function P(be, Ce, Ne) {
        ...
        function Ot(ut, Dt, yt) {
          var ft = Ga(e, Ie, null, ut),
            ...
            lt =
              yt == "after" ? ft.begin : ft.end - (/\s/.test(Ie.text.charAt(ft.end - 1)) ? 2 : 1);
          return rt(lt, ct)[ct];
        }
    ...
    function pf(e, t, n, r) {
      ...
      for (var a = 0; a < 5; a++) {
        ...
        if (
          ...
          m.scrollLeft != null &&
            (Dr(e, m.scrollLeft), Math.abs(e.doc.scrollLeft - P) > 1 && (l = !0)),
          !l)
        )
          break;
      }
        ...
        if (!P.hidden)
          if (!P.node || P.node.parentNode != a) {
            ...
            (P.changes && (Se(P.changes, "gutter") > -1 && (Y = !1), Ma(e, P, m, n)),
              Y &&
                (j(P.lineNumber),
                P.lineNumber.appendChild(document.createTextNode(he(e.options, m)))),
    ...
    function an(e, t, n) {
      ...
      if (
        !((Ft(e, "beforeChange") || (e.cm && Ft(e.cm, "beforeChange"))) && ((t = Cl(e, t, !0)), !t))
      ) {
      ...
      ((e.prototype = {
        ...
        findPosV: function (r, i, a, l) {
          ...
          for (var m = Re(this.doc, r), A = 0; A < i; ++A) {
            var P = Xt(this, m, "div");
            if ((f == null ? (f = P.left) : (P.left = f), (m = as(this, P, u, a)), m.hitSide))
              break;
          }
          return m;
        },
...
var ys = Ke((vs, bs) => {
  (function (o) {
    ...
    function T(x) {
      ...
      S(d, z.to) > 0 &&
        (d.line - z.from.line < C ? (w.pop().clear(), s(x, z.from, d)) : s(x, z.to, d));
    }
  });
});
var ks = Ke((xs, _s) => {
...
`),
    ...
    function T(y, R, M) {
      ...
      R = C(R, "gm");
      for (
        var H, Z = 1, ee = y.getLine(M.line).length - M.ch, re = M.line, N = y.firstLine();
        re >= N;
      ...
      hooks: {
        ...
        "=": function (I, B) {
          ...
          return le.type == "}" && le.align && I.eat(">")
            ? ((B.context = new p(le.indented, le.column, le.type, le.info, null, le.prev)),
              "operator")
            : !1;
        },
        "/": function (I, B) {
    ...
    (Q("text/x-kotlin", {
      ...
      hooks: {
        ...
        indent: function (I, B, le, xe) {
          ...
          if (B.align && B.type == "}")
            return B.indented + (I.context.type == (le || "").charAt(0) ? 0 : xe);
        },
      },
    ...
    (o.defineMode("xml", function (C, b) {
      ...
      function R(_, K, X) {
        ((this.prev = _.context),
          ...
          (this.startOfLine = X),
          (s.doNotIndent.hasOwnProperty(K) || (_.context && _.context.noIndent)) &&
            (this.noIndent = !0));
      }
      function M(_) {
...
var vn = Ke((Fs, Ns) => {
  (function (o) {
    ...
    (o.defineMode("javascript", function (p, v) {
      ...
      function B(k) {
        return (
          k == "public" || k == "private" || k == "protected" || k == "abstract" || k == "readonly"
        );
      }
      function le(k, O, ae) {
      ...
      function Kr(k, O) {
        return k == "{"
          ? se(Kr, "}")
          : (k == "variable" && X(O), O == "*" && (j.marked = "keyword"), _(_n));
      }
      function Vt(k) {
        if (k == ",") return _(Kr, Vt);
      }
      ...
      return {
        startState: function (k) {
          ...
          return (
            v.globalVars && typeof v.globalVars == "object" && (O.globalVars = v.globalVars),
            O
          );
        },
        token: function (k, O) {
...
var Qn = Ke((Os, Ps) => {
  (function (o) {
    ...
    function h(T, x) {
      for (var c in T)
        for (var d = x[c] || (x[c] = []), w = T[c], E = w.length - 1; E >= 0; E--) d.unshift(w[E]);
    }
    function g(T, x) {
...
var Di = Ke((Bs, Ws) => {
  (function (o) {
          ...
          if (Z) {
            ...
            if (
              ...
              for (var re = 2; re < Z.length; re++)
                Z[re] &&
                  (w.pending || (w.pending = [])).push({ text: Z[re], token: H.token[re - 1] });
    ...
    function h(x, c, d, w) {
      ...
      (d.persistent &&
        !E &&
        (c.persistentStates = { mode: y, spec: d.spec, state: R, next: c.persistentStates }),
        (c.localState = R),
        (c.local = {
          mode: y,
          end: d.end && v(d.end),
    ...
    (o.defineMode(
      ...
      function (p, v) {
        ...
        function D(q) {
          ...
          if (q.formatting) {
            (L.push(s.formatting),
              typeof q.formatting == "string" && (q.formatting = [q.formatting]));
    ...
    (o.defineMode("nginx", function (p) {
      ...
      return {
        ...
        token: function (w, E) {
          ...
          return (
            h == "hash" && y == "rule"
              ? (z = "atom")
              : z == "variable" &&
                (y == "rule" ? (z = "number") : (!y || y == "@media{") && (z = "tag")),
        ...
        indent: function (w, E) {
          ...
          return (
            /^\}/.test(E) && (z -= w.stack[w.stack.length - 1] == "rule" ? 2 : 1),
            w.baseIndent + z * s
          );
        },
        electricChars: "}",
  ...
  (function (o) {
    ...
    function b(T, x, c, d) {
      ...
      for (
        var w = !1;
        !T.eol() &&
        (w || d === !1 || (!T.match("{$", !1) && !T.match(/^(\$[a-zA-Z_][a-zA-Z0-9_]*|\$\{)/, !1)));
    ...
    (o.defineMode(
      ...
      function (T, x) {
        ...
        function w(E, z) {
          var y = z.curMode == d;
          if (
            (E.sol() && z.pending && z.pending != '"' && z.pending != "'" && (z.pending = null), y)
          )
      ...
      function ee(K, X) {
        ...
        if ((I && (X.indent = K.indentation()), I && S(X).type == "py")) {
          ...
          if (K.eatSpace()) {
            ...
            return (
              le > B ? D(X) : le < B && j(K, X) && K.peek() != "#" && (X.errorToken = !0),
              null
            );
          } else {
            var xe = re(K, X);
      ...
      var _ = {
        ...
        token: function (K, X) {
          ...
          return (
            B &&
              B != "comment" &&
              (X.lastToken = B == "keyword" || B == "punctuation" ? K.current() : B),
    ...
    (o.defineMode("ruby", function (g) {
      ...
      function c(M, H) {
        ...
        if (Z == "%") {
          ...
          var F = M.eat(/[^\w\s=]/);
          return F
            ? (s.propertyIsEnumerable(F) && (F = s[F]), x(z(F, re, N, !0), M, H))
            : "operator";
        } else {
          ...
          if (Z == "?") {
            ...
            if (Z == "|" && (H.varList || H.lastTok == "{" || H.lastTok == "do"))
              return ((T = "|"), null);
      ...
      function (p) {
        ...
        function ee(N, F) {
          ...
          if (F.cursorHalf) {
            ...
            if (D === "$")
              return (N.next(), N.eatWhile(/[\w-]/), E(N) && (F.cursorHalf = 0), "variable-2");
            if (D === "!")
              return (N.next(), (F.cursorHalf = 0), N.match(/^[\w]+/) ? "keyword" : "operator");
            ...
            if (N.eatWhile(/[\w-]/))
              if (N.match(/ *: *[\w-\+\$#!\("']/, !1)) {
                ...
                return N.match(/ *:/, !1)
                  ...
                  : (N.match(/ *,/, !1) || H(F), "tag");
            if (D === ":")
              return N.match(d) ? "variable-3" : (N.next(), (F.cursorHalf = 1), "operator");
          }
  ...
  (function (o) {
    ...
    (o.defineMode("shell", function () {
      ...
      function s(d, w) {
        ...
        if (z === "#")
          return E && d.eat("!") ? (d.skipToEnd(), "meta") : (d.skipToEnd(), "comment");
  ...
  (function (o) {
    ...
    o.defineMode("stylus", function (M) {
      ...
      function je($, W) {
        return (
          $.next(),
          $.match(/\s*[\"\')]/, !1) ? (W.tokenize = null) : (W.tokenize = Se(")")),
          [null, "("]
        );
      }
      function Ze($, W, se, De) {
      ...
      function fe($, W) {
        return (
          (Me(W) && ($ == "{" || $ == "]" || $ == "hash" || $ == "qualifier")) || $ == "block-mixin"
        );
      }
      function oe($, W) {
      ...
      return (
        (de.block = function ($, W, se) {
          ...
          if ($ == "word") {
            ...
            if (ge == "block-keyword")
              return (
                (ge = "keyword"),
                W.current(/(if|unless)/) && !we(W) ? "block" : ke(se, W, "block")
              );
              ...
              : (W.string.match(/^[a-z][\w-]*\(/i) && Me(W)) ||
                ...
                : W.string.match(/^[\$-]?[a-z][\w-\.\[\]\'\"]*\s*=/) ||
                  ...
                  : Me(W)
                    ...
                    : ke(se, W, "block", 0);
          if (
            ($ && $.charAt(0) == "@" && G(W.current().slice(1)) && (ge = "variable-2"), $ == "word")
          ) {
            var De = W.current();
            ((ge = te(De)),
        ...
        (de.atBlock = function ($, W, se) {
          ...
          return (
            $ == "operator" && /^(not|and|or)$/.test(W.current()) && (ge = "keyword"),
            se.context.type
          );
        }),
        ...
        (de.interpolation = function ($, W, se) {
          return (
            ...
            $ == "}"
              ...
              : $ == "variable-name"
                ? ke(se, W, "variableName", 0)
                : ($ == "word" && ((ge = te(W.current())), ge == "tag" && (ge = "atom")),
                  se.context.type)
          );
        }),
  ...
  (function (o) {
    ...
    (o.defineMode(
      ...
      function (p) {
        ...
        function T(U, G) {
          if (
            (U.sol() && ((G.javaScriptLine = !1), (G.javaScriptLineExcludesColon = !1)),
            G.javaScriptLine)
          ) {
        ...
        function w(U, G) {
          if (U.match("#{"))
            return ((G.isInterpolating = !0), (G.interpolationNesting = 0), "punctuation");
        }
        function E(U, G) {
        ...
        function y(U, G) {
          if (U.match(/^when\b/))
            return ((G.javaScriptLine = !0), (G.javaScriptLineExcludesColon = !0), v);
        }
        function R(U) {
...
`),
      ...
      if (w === void 0)
        for (E = s.lineCount(), w = N; w < E && ((x = s.getLineHandle(w)), !v(x)); w++);
      (s.operation(function () {
