        ...
        return a instanceof u &&
          ...
          : (h !== "noscript" && h !== "noembed" && h !== "noframes") ||
            ...
            ? (Pt &&
                ...
                a.textContent !== g &&
                  (oe(e.removed, { element: a.cloneNode() }), (a.textContent = g))),
...
`),
  ...
  vs = function (i) {
    let t = !1,
      ...
      r = e[e.length - 1];
    return r
      ? ((n = n.map((o) => (o.isBlockBreak() ? ((t = !0), xs(o)) : o))), t ? new J([...n, r]) : i)
      : i;
  },
    ...
    constructor(t) {
      ...
      (super(...arguments),
        ...
        (this.inputController =
          bi.getLevel() === 2 ? new wt(this.editorElement) : new Y(this.editorElement)),
