    ...
    ((b = t[v % o]),
      !b.skip &&
        ...
        y !== _ &&
          ...
          p !== null &&
            k() &&
            (m.push(To({ start: p, end: v, loop: d, count: o, style: f })), (p = null)),
          (T = v),
          (_ = y))));
...
var be = class i extends pt {
  ...
  He = class {
    ...
    register(t) {
      ...
      return (
        r in n || ((n[r] = t), Mu(t, o, s), this.override && A.override(t.id, t.overrides)),
        o
      );
    }
    get(t) {
...
function yd(i, t, e) {
  let { x: s, y: n, startAngle: r, pixelMargin: o, fullCircles: a } = t,
    ...
    c = t.innerRadius + o,
    h;
  for (e && hl(i, t, r + H), i.beginPath(), i.arc(s, n, c, r + H, r, !0), h = 0; h < a; ++h)
    i.stroke();
...
function fr(i, t, e) {
  ...
  s &&
    n.points.length &&
    (Si(i, e),
    ef(i, { line: n, target: s, above: h, below: u, area: e, scale: r, axis: o }),
    ki(i));
}
function ef(i, t) {
...
var Sf = (i, t) => (i === null ? null : tt(Math.round(i), 0, t)),
  Ke = class extends be {
    ...
    parse(t, e) {
      ...
      let s = this.getLabels();
      return (
        (e = isFinite(e) && s[e] === t ? e : wf(s, t, E(e, t), this._addedLabels)),
        Sf(e, s.length - 1)
      );
    }
    determineDataLimits() {
      ...
      return rn(this, t, zr, () => {
        ...
        return (
          this.monthsCache[n][t] ||
            (this.monthsCache[n][t] = Kf((r) => this.extract(r, s, "month"))),
          this.monthsCache[n][t]
        );
      });
    }
      ...
      return rn(this, t, Vr, () => {
        ...
        return (
          this.weekdaysCache[n][t] ||
            (this.weekdaysCache[n][t] = Jf((r) => this.extract(r, s, "weekday"))),
          this.weekdaysCache[n][t]
        );
      });
    }
...
function uo(i) {
  return (
    i.localWeekData === null &&
      (i.localWeekData = as(i.c, i.loc.getMinDaysInFirstWeek(), i.loc.getStartOfWeek())),
    i.localWeekData
  );
}
function ve(i, t) {
