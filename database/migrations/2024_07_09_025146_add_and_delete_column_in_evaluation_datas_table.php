...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('evaluation_datas', function (Blueprint $table) {
            ...
            DB::statement('ALTER TABLE evaluation_datas CHANGE kerapian_pakaian kerapian_kerja VARCHAR(255) DEFAULT "C"');
    ...
    public function down(): void
    {
        Schema::table('evaluation_datas', function (Blueprint $table) {
            ...
            DB::statement('ALTER TABLE evaluation_datas CHANGE kerapian_kerja kerapian_pakaian VARCHAR(255)');
