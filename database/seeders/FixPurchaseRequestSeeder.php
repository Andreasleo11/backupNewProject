...
class FixPurchaseRequestSeeder extends Seeder
{
    ...
    private function fixPurchaseRequetType()
    {
        ...
        \App\Models\PurchaseRequest::whereIn("from_department", $officeDepartments)->chunkById(
            $chunkSize,
        ...
        \App\Models\PurchaseRequest::whereNotIn("from_department", $officeDepartments)->chunkById(
            $chunkSize,
            function ($purchaseRequests) {
                foreach ($purchaseRequests as $purchaseRequest) {
    ...
    private function fixPurchaseRequestDetails()
    {
        ...
        foreach ($prs as $pr) {
            \App\Models\DetailPurchaseRequest::where("purchase_request_id", $pr->id)
